<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="CollaboratorDisplay.aspx.cs" Inherits="VietNamNet.CMS.CollaboratorDisplay" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cplhContainer">
    <div class="pd05">
        ...
        <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
            ...
            <br />
            <p>
                <asp:Label ID="lblNameLabel" runat="server" CssClass="label w150" Text="Cộng tác viên:"></asp:Label>
                <asp:Label ID="lblName" runat="server" CssClass="label w450" Text=""></asp:Label>
                <br class="clear" />
            </p>
            <p>
                <asp:Label ID="lblDetailLabel" runat="server" CssClass="label w150" Text="Thông tin:"></asp:Label>
