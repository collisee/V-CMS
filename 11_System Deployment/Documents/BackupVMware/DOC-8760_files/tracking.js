...
function riaLink(name) {
  ...
  if (s_account)
        account = s_account;
//  console.log("riaLink executed in "+account);
  var s=s_gi(account);
  s.linkTrackVars='None';
  s.linkTrackEvents='None';
  if (s.pageName) {
...
if (window.location.host == 'redesign.vmware.com' || window.location.host == 'wcm.vmware.com' || window.location.host == 'wcm-training.vmware.com' || window.location.host == 'wcm-intl.vmware.com' || window.location.host == 'wwwa-dev-sso-1.vmware.com' || window.location.host == 'wwwa-qa-sso-1.vmware.com' || window.location.host == 'govirtual-jive-dev-1.vmware.com' || window.location.host == 'vmweb-test.vmware.com' || window.location.host == 'supportuat.vmware.com' || window.location.host == 'vmshare-stage.vmware.com'  || window.location.host.match(/^siebwebdev/) || window.location.host.match(/^siebwebtest/) || window.location.host.match(/^eservice-stage/) || window.location.host.match(/^phnx-portal/) || window.location.host == 'newcastle.vmware.com' || window.location.host == 'vmworld2009-test.wingateweb.com' || window.location.host == 'portal-vmwperf.vmware.com' || window.location.host == 'cs2.salesforce.com' || window.location.host.match(/^vam-dev/)) {	
        s_account="vmwaredev"
        ...
        s.dynamicAccountMatch=window.location.host
} else if (window.location.host == 'na6.salesforce.com' || window.location.host == 'vmware.zinfi.com') {
        s_account="vmwarepartnercentral"
        var s=s_gi(s_account)
        s.dynamicAccountSelection=false
} else {
        var s=s_gi(s_account)
        s.dynamicAccountSelection=true
        s.dynamicAccountList="vmwarede,vmwareglobal=vmware.com/de/;vmwarefr,vmwareglobal=vmware.com/fr/;vmwarecn,vmwareglobal=vmware.com/cn/;vmwarejp,vmwareglobal=vmware.com/jp/;vmwarees,vmwareglobal=vmware.com/es/;vmwarelasp,vmwareglobal=vmware.com/lasp/;vmwareru,vmwareglobal=vmware.com/ru/;vmwareat,vmwareglobal=vmware.com/at/;vmwarebr,vmwareglobal=vmware.com/br/;vmwareit,vmwareglobal=vmware.com/it/;vmwarekr,vmwareglobal=vmware.com/kr/;vmwarese,vmwareglobal=vmware.com/se/;vmwarech,vmwareglobal=vmware.com/ch/;vmwaretw,vmwareglobal=vmware.com/tw/;vmwareap,vmwareglobal=vmware.com/ap/;vmwarepl,vmwareglobal=vmware.com/pl/;vmwarecz,vmwareglobal=vmware.com/cz/;vmwarenl,vmwareglobal=vmware.com/nl/;vmwarefrbe,vmwareglobal=vmware.com/fr_be/;vmwarenlbe,vmwareglobal=vmware.com/nl_be/;vmwarecafr,vmwareglobal=vmware.com/ca/fr/;vmwarecaen,vmwareglobal=vmware.com/ca/en/;vmwareuk,vmwareglobal=vmware.com/uk/"
        s.dynamicAccountMatch=window.location.host+window.location.pathname
}
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx,iso,rar,gz,tar,gzip,jar,ovf,dmg,msi,bundle"
s.linkInternalFilters="javascript:,vmware.com,vmworld.com,vmworld2008.com,vmworld2008.wingateweb.com,vmworldeurope09.com"
