...
URLobj.init = function(pathname) {
   ...
   /* international */
    ...
    this.country=["de","fr","cn","jp","es","lasp","ru","tw","at","br","it","kr","ap","cz","nl","pl","ch","se","nl_be","fr_be","caen","cafr","uk"];
    this.siteid=["vmwde","vmwfr","vmwcn","vmwjp","vmwes","vmwlasp","vmwru","vmwtw","vmwat","vmwbr","vmwit","vmwkr","vmwap","vmwcz","vmwnl","vmwpl","vmwch","vmwse","vmwbenl","vmwbefr", "vmwcaen", "vmwcafr", "vmwuk"];
    this.ccode="vmware";
    this.ccodeidx="undef";
...
//    this.subdomain = (this.host.length > 2) ? this.host[0]  : "www";
   ...
   /* vmworld2008 homepage */
   if (window.location.host.match("vmworld2008.com")&&(window.location.pathname=="/"||window.location.pathname=="/index.html"))
         this.hier1="vmware,conferences,2008";
