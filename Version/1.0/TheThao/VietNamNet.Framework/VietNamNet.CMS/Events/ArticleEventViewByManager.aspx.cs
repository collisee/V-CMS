...
{
    public partial class ArticleEventViewByManager : BasePageView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string url =
                    Utilities.SetParamForURL(CMSConstants.FormNames.CMS.Events.ArticleEventViewByCategory,
        ...
        private void Initialize()
        {
            ...
            ActionName = CMSConstants.Services.ArticleEventManager.Actions.ViewGetAllArticleEventByManager;
        }
            ...
            switch (((RadToolBarButton)e.Item).CommandName)
            {
                ...
                case Constants.CommandNames.Search:
                    ...
                    string url = (cateId == 0)
                        ...
                        : Utilities.SetParamForURL(CMSConstants.FormNames.CMS.Events.ArticleEventViewByCategory, Constants.ParameterName.KEYWORD, kw);
                    url =
