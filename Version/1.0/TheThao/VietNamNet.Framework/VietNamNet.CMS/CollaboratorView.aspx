<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="CollaboratorView.aspx.cs" Inherits="VietNamNet.CMS.CollaboratorView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Name" HeaderText="Cộng tác viên" UniqueName="Name">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Detail" HeaderText="Thông tin" UniqueName="Detail">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                            ConfirmText="Bạn c&#243; chắc chắn muốn X&#243;a cộng tác viên n&#224;y?" ConfirmTitle="X&#243;a"
