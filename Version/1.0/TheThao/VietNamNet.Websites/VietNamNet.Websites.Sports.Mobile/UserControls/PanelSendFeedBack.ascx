<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelSendFeedBack.ascx.cs" Inherits="VietNamNet.Websites.Sports.Mobile.UserControls.PanelSendFeedBack" %>
    ...
    <div style="border-bottom:solid 1px #ccc;">
        ...
        <p style="padding:6px;">
            ...
            <img alt="" src="http://res.vietnamnet.vn/mobile/images/refresh.gif" style="cursor:pointer;" onclick="reloadValidImage()" />
        ...
        <p style="padding:6px;">
            ...
            <asp:HiddenField ID="hidEmailTo" runat="server" Value="banthethao@vietnamnet.vn" />
            <asp:HiddenField ID="hidEmailCC" runat="server" Value="" />
            <asp:HiddenField ID="hidEmailBCC" runat="server" Value="tuananh@vietnamnet.vn;ndthieu@vietnamnet.vn" />
            <asp:HiddenField ID="hidEmailSubject" runat="server" Value="Thể thao VNN - Ý kiến từ mobile: " />
