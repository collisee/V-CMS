...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelNewsDetail.ascx.cs" Inherits="VietNamNet.Websites.Sports.Mobile.UserControls.PanelNewsDetail" %>
...
<asp:Repeater ID="rptNewsDetail" runat="server">
    <ItemTemplate>
        ...
        <p style="text-align:center">
            <img alt="Quảng cáo" title="Quảng cáo" src="/images/banner-kqsx-mb.gif" width="300" />
        </p>
