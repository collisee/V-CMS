        ...
        <div class="home5right">
            <div class="home5_right">
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">                            
                            <uc:PanelCateBox1 CategoryAlias="giao-duc-tieu-diem" ID="PanelCateBox1_1" runat="server" />
                            <uc:PanelCateBox1 CategoryAlias="giao-duc-dong-su-kien" ID="PanelCateBox1_2" runat="server" />
                        </div>
