...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="VietNamNet.Websites.V1.ui.thitruong.Detail" %>
        ...
        <div class="home5right">
            <div class="home5_right">
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">                                                        
                            <uc:PanelCateBox1 CategoryAlias="phong-su-dieu-tra-dong-su-kien" ID="PanelCateBox1_2" runat="server" />
                        </div>
