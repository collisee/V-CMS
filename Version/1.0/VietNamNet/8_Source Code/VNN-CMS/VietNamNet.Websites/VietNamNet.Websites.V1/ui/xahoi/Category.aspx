...
<%@ Register Src="~/UserControls/Categories/PanelCateImageNews.ascx" TagName="PanelCateImageNews" TagPrefix="uc" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelCateHotNews CategoryAlias="xa-hoi" ID="PanelCateHotNews1" runat="server" />
            <uc:PanelCateCenterPoint CategoryAlias="xa-hoi" FirstIndexRecord="2" LastIndexRecord="4"
                ID="PanelCateCenterPoint1" runat="server" />
            <div class="clear">,</div>
            <uc:PanelCateHotSlide CategoryAlias="xa-hoi-tam-diem" FirstIndexRecord="1" LastIndexRecord="15"
        ...
        <div class="home5right">
            <div class="home5_right">
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">
                            <uc:PanelCateImageNews CategoryAlias="xa-hoi-tam-diem" FirstIndexRecord="1" LastIndexRecord="3" ID="PanelCateImageNews1" runat="server" />                            
                            <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" CategoryAlias="xa-hoi-tieu-diem" ID="PanelCateBox1_1" runat="server" />
                            <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" CategoryAlias="xa-hoi-dong-su-kien" ID="PanelCateBox1_2" runat="server" />
