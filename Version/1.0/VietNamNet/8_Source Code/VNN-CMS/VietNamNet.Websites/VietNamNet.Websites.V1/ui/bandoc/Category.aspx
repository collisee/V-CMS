...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" Codebehind="Category.aspx.cs"
  Inherits="VietNamNet.Websites.V1.ui.bandoc.Category" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  <uc:PanelCateTicker CategoryAlias="ban-doc-phap-luat" ID="PanelCateTicker1" runat="server" />
  <div id="home4">
    <div id="home4_1">
      <uc:PanelCateHotNews CategoryAlias="ban-doc-phap-luat" ID="PanelCateHotNews1" runat="server" />
      <uc:PanelCateCenterPoint CategoryAlias="ban-doc-phap-luat" ID="PanelCateCenterPoint1"
        runat="server" />
      <div class="clear">
        ,</div>
      <uc:PanelCateHotSlide CategoryAlias="ban-doc-phap-luat-tam-diem" FirstIndexRecord="1"
        LastIndexRecord="15" ID="PanelCateHotSlide1" runat="server" />
    </div>
    <div id="home4_2">
  ...
  <div id="home5">
    <div class="home5left">
      ...
      <uc:PanelCateContent CategoryAlias="ban-doc-phap-luat" ID="PanelCateContent1" runat="server" />
      <uc:PanelOtherNews CategoryAlias="ban-doc-phap-luat" ID="PanelOtherNews1" runat="server" />
    </div>
    <div class="home5right">
      <div class="home5_right">
        <uc:PanelCateBox CategoryAlias="ban-doc-phap-luat-chia-se" FirstIndexRecord="1" LastIndexRecord="3"
        ...
        <div class="row">
          <div>
            <div class="tt_ck">
              <uc:PanelCateBox1 CategoryAlias="ban-doc-phap-luat-tieu-diem" FirstIndexRecord="1"
                LastIndexRecord="3" ID="PanelCateBox1_2" runat="server" />
              <vnn:PaneSurvey ID="PaneSurvey1" runat="server" CategoryAlias="ban-doc-phap-luat" />
            </div>
  ...
  <uc:PanelAdvertisement CategoryAlias="ban-doc-phap-luat" ID="PanelAdvertisement1"
    runat="server" />
</asp:Content>
