...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="VietNamNet.Websites.V1.ui.thitruong.Category" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelCateHotNews CategoryAlias="kinh-te" ID="PanelCateHotNews1" runat="server" />
            <uc:PanelCateCenterPoint CategoryAlias="kinh-te" FirstIndexRecord="1" LastIndexRecord="3"
                ID="PanelCateCenterPoint1" runat="server" />
            <div class="clear">,</div>
            <uc:PanelCateHotSlide CategoryAlias="kinh-te-tam-diem" FirstIndexRecord="5" LastIndexRecord="9"
    ...
    <div id="home5">
        ...
        <div class="home5right">
            <div class="home5_right">
                <uc:PanelCateBox CategoryAlias="bao-ve-nguoi-tieu-dung" FirstIndexRecord="1" LastIndexRecord="4" ID="PanelCateBox1" runat="server" />                
                <div class="row">
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">                            
                           <uc:PanelCateBuySell FirstIndexRecord="1" LastIndexRecord="15" CategoryAlias="kinh-te-rao-vat" id="PanelCateBuySell1" runat="server" />                           
