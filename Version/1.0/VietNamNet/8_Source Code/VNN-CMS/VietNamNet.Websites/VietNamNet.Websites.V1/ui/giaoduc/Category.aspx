...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="VietNamNet.Websites.V1.ui.giaoduc.Category" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelCateHotNews CategoryAlias="giao-duc" ID="PanelCateHotNews1" runat="server" />
            <uc:PanelCateCenterPoint CategoryAlias="giao-duc" FirstIndexRecord="2" LastIndexRecord="4" ID="PanelCateCenterPoint1" runat="server" />
            <div class="clear">,</div>
            <uc:PanelCateHotSlide CategoryAlias="giao-duc-tieu-diem" FirstIndexRecord="1" LastIndexRecord="15" ID="PanelCateHotSlide1" runat="server" />
        </div>
        <div id="home4_2">
    ...
    <div id="home5">
        ...
        <div class="home5right">
            <div class="home5_right">
                <uc:PanelCateBox CategoryAlias="giao-duc-du-hoc" FirstIndexRecord="1" LastIndexRecord="3"
                    ID="PanelCateBox1" runat="server" />
                <uc:PanelCateBox CategoryAlias="giao-duc-nep-nha" FirstIndexRecord="1" LastIndexRecord="3"
                    ID="PanelCateBox2" runat="server" />
                <uc:PanelCateBox CategoryAlias="giao-duc-chuyen-giang-duong" FirstIndexRecord="1" LastIndexRecord="3"
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">                            
                            <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" CategoryAlias="giao-duc-tieu-diem" ID="PanelCateBox1_1" runat="server" />
                            <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" CategoryAlias="giao-duc-dong-su-kien" ID="PanelCateBox1_3" runat="server" />                            
                            <vnn:PaneSurvey ID="PaneSurvey1" runat="server" CategoryAlias="xa-hoi" />              
                        </div>
