...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  ...
  <div id="home4">
    <div id="home4_1">
      <uc:PanelCateHotNews CategoryAlias="cong-nghe-thong-tin-vien-thong" ID="PanelCateHotNews1"
        runat="server" />
      <uc:PanelCateCenterPoint CategoryAlias="cong-nghe-thong-tin-vien-thong" ID="PanelCateCenterPoint1"
        runat="server" />
      <div class="clear">
        ,</div>
  ...
  <uc:PanelAdvertisement CategoryAlias="cong-nghe-thong-tin-vien-thong" ID="PanelAdvertisement1"
    runat="server" />
</asp:Content>
