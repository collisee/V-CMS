...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="VietNamNet.Websites.V1.ui.psdt.Category" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelCateHotNews CategoryAlias="phong-su-dieu-tra" ID="PanelCateHotNews1" runat="server" />
            <uc:PanelCateCenterPoint CategoryAlias="phong-su-dieu-tra" FirstIndexRecord="1" LastIndexRecord="3"
                ID="PanelCateCenterPoint1" runat="server" />
            <div class="clear">,</div>
            <uc:PanelCateHotSlide CategoryAlias="phong-su-dieu-tra-tam-diem" FirstIndexRecord="1" LastIndexRecord="15"
    ...
    <div id="home5">
        ...
        <div class="home5right">
            <div class="home5_right">
                <uc:PanelCateBox FirstIndexRecord="1" LastIndexRecord="4" CategoryAlias="bao-ve-nguoi-tieu-dung" ID="PanelCateBox1" runat="server" />                
                <div class="row">
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">                            
                           <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" CategoryAlias="phong-su-dieu-tra-se-chia-tri-an" ID="PanelCateBox1_2" runat="server" />
