...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelCateHotNews CategoryAlias="chinh-tri" ID="PanelCateHotNews1" runat="server" />
            <uc:PanelCateCenterPoint CategoryAlias="chinh-tri" FirstIndexRecord="2" LastIndexRecord="4"
