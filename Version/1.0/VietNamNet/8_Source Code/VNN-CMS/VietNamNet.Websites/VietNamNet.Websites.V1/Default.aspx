...
<%@ Register Src="UserControls/Homepage/PanelHorizontalBar.ascx" TagName="PanelHorizontalBar"
    TagPrefix="uc" %>
<%@ Register Src="UserControls/Homepage/PanelCateBoxSmallHorizontal.ascx" TagName="PanelCateBoxSmallHorizontal"
    TagPrefix="uc" %>
...
<%@ Register Src="UserControls/Homepage/PanelMoinong.ascx" TagName="PanelMoinong" TagPrefix="uc" %>
<%@ Register Src="UserControls/Homepage/PanelAdvC_1_4.ascx" TagName="PanelAdvC_1_4" TagPrefix="uc" %>
<%@ Register Src="UserControls/Homepage/PanelAdCenter.ascx" TagName="PanelAdCenter" TagPrefix="uc" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelTopNews ID="PanelTopNews1" runat="server" CategoryAlias="tin-noi-bat" />
            <uc:PanelMoinong ID="PanelMoinong1" runat="server" CategoryAlias="moi-nong" FirstIndexRecord="1"
                LastIndexRecord="8" />
            <div class="clear">,</div>
            <uc:PanelHorizontalBar ID="PanelHorizontalBar1" runat="server" />            
            <uc:PanelTamdiem ID="PanelTamdiem1" runat="server" CategoryAlias="tam-diem" FirstIndexRecord="1" LastIndexRecord="15" />
            <uc:PanelCateBoxSmallHorizontal FirstIndexRecord="1" LastIndexRecord="2" CategoryAlias="ho-chi-minh" ID="PanelCateBoxSmallHorizontal1" runat="server" />                        
