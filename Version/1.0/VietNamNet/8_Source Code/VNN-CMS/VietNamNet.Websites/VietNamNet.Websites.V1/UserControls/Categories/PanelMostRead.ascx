...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelMostRead.ascx.cs" Inherits="VietNamNet.Websites.V1.UserControls.Categories.PanelMostRead" %>
