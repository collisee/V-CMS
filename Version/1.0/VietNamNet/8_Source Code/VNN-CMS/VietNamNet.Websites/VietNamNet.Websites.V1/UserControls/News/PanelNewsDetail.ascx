        ...
        <div class=" tool row" id="article-tool">
            ...
            <div class="tool2">
                <font size="2" style="font-family: Arial;"><a class="facebook" href="javascript:;"
                    ...
                    <img alt="share" title="share" height="39" width="28" src="/images/fb_icon.gif" />
                </a><a class="tw" href="javascript:;" onclick="share_twitter();">
                    <img alt="share" title="share" height="39" width="28" src="/images/tw_icon.gif" />
                </a></font>
            </div>
            <font size="2" style="font-family: Arial;"></font>
            <div class="tool1">
                <font size="2" style="font-family: Arial;"><span class="chiase">Chia sẻ</span> <a
                    title="In bài này" class="print" href="javascript:void(0)" onclick="window.open(window.location.href.replace('/vn/', '/vn/print/'));">
                    In bài này</a> <a id="cmdSendEmail" title="Gửi cho bạn bè" class="mail">Gửi bài</a>
                    <a title="Gửi phản hồi" class="feedback" href="<%#DataBinder.Eval(Container.DataItem, "Id") %>">
                        Gửi phản hồi</a> </font>
            </div>
        </div>
