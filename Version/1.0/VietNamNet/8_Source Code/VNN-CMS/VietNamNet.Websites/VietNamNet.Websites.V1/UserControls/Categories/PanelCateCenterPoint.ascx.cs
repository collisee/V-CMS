...
{
    public partial class PanelCateCenterPoint : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                helperArticles.ValueObject.FirstIndexRecord = 2;
                ...
                rptCenterPoint.DataSource = dtArticles;
                rptCenterPoint.DataBind();
            }
        }
