...
<div class="panel1 photoSlide catePhoto pb10" id="photoSlide">
    <div class="pnl-top">
        <a href="#" class="title">
            <img alt="#" src="/images/photo_r.gif" />&nbsp;Tin ảnh
        </a>
    </div>
    <div class="pnl-content">
        <div class="prev">
            <a href="javascript:void(0)">
                <img height="35" width="18" title="" alt="" src="/images/tinanh_p.gif" /></a>
        </div>
        ...
        <div class="next">
            <a href="javascript:void(0)">
                <img height="35" width="18" title="" alt="" src="/images/tinanh_n.gif" />
            </a>
        </div>
        <br class="clear" />
    </div>
