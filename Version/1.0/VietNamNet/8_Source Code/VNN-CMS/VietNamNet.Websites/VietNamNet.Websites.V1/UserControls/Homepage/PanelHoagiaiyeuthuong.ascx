...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelHoagiaiyeuthuong.ascx.cs" Inherits="VietNamNet.Websites.V1.UserControls.Homepage.PanelHoagiaiyeuthuong" %>

<div class="box-vnr500 row">
  <div class="vnr500">
    <div class="hgyt-title">
      <a href="http://day0909.net/" target="_blank">
