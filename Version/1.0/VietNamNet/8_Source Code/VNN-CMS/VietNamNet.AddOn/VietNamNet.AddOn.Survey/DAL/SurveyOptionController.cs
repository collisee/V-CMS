...
namespace VietNamNet.AddOn.SurveyModule.DAL
{
    ...
    public partial class SurveyOptionController
    {
	    ...
	    public void Insert(int SurveyId,string OptionName,int ViewOrder,string Notes,bool? IsOther,bool? IsCorrect,string CreatedBy,DateTime CreatedOn,string ModifiedBy,DateTime ModifiOn,bool IsDeleted,bool IsActive)
	    {
