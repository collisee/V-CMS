<%@ Page MasterPageFile="~/Popup.Master" Language="C#" AutoEventWireup="true" CodeBehind="PopupSurveyListApproved.aspx.cs" Inherits="VietNamNet.AddOn.Survey.PopupSurveyListApproved" Title="Chọn Bình chọn" ValidateRequest="false" %>
        ...
        <script type="text/javascript">   
          ...
          function getRadWindow()
           ...
           function onKeyPress(sender, args) {
			...
			function insertSurvey(surveyid, text){
                //bind data return
                var arg = {text: ''};
                
                //getData
                arg.text = '<div id="survey_'+surveyid+'" survey="true" surveyid='+surveyid+' ><div style="padding: 3px; border:1px solid #C9C9C9;background:#F0F0F0;">'+text+'<div></div>';
                    ...
                    <Columns>                        
                        ...
                        <telerik:GridTemplateColumn HeaderText="Chức năng" HeaderStyle-Width="200">
                             <ItemTemplate>  
                                ...
                                <a href="javascript: void(0);" onclick="insertSurvey('<%# DataBinder.Eval(Container.DataItem,"SurveyId") %>','<%# DataBinder.Eval(Container.DataItem,"Question") %>')">Sử dụng Bình chọn này</a>
