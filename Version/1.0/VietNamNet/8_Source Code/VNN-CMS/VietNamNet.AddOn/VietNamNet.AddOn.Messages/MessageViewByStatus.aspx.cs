...
{
    public partial class MessageViewByStatus : BasePageView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            status = Request.Params[Constants.ParameterName.STATUS];
        ...
        private void Initialize()
        {
            ...
            ActionName = MessagesConstants.Services.MessageManager.Actions.ViewGetAllPrivateMessagesByStatus;
        }
        ...
        protected override DataTable BindSearchingTable()
        {
            ...
            drSearch[Constants.Paging.Direction.Status] = status;
