...
{
    public class RoomBookingDAO : BaseDAO
    {
        ...
        {
            string insertString = "Insert Into [RoomBooking]" +
                                  "([Subject],[StartTime],[EndTime],[RecurrenceRule],[RecurrenceParentID],[RoomId],[Created_At],[Created_By],[Last_Modified_At],[Last_Modified_By],[flag]) " +
                                  "Values(@Subject, @StartTime, @EndTime, @RecurrenceRule, @RecurrenceParentID, @RoomId, @Created_At, @Created_By, @Last_Modified_At, @Last_Modified_By, @Flag) " +
                ...
                SqlParameter[] paramArray = new SqlParameter[]
                    {
                        ...
                        CreateSqlPrameter("@RoomId", SqlDbType.Int, 0, ParameterDirection.Input),
            ...
            {
                throw new Exception("RoomBookingDAO::Insert::Error", ex);
            }
        }
        ...
        {
            string updateString = @"Update [RoomBooking] Set" +
                                  " [Subject] = @Subject, [StartTime] = @StartTime, [EndTime] = @EndTime, [RecurrenceRule] = @RecurrenceRule, [RecurrenceParentID] = @RecurrenceParentID, [RoomId] = @RoomId, [Created_At] = @Created_At, [Created_By] = @Created_By, [Last_Modified_At] = @Last_Modified_At, [Last_Modified_By] = @Last_Modified_By, [flag] = @flag " +
            ...
            {
                throw new Exception("RoomBookingDAO::Update::Error", ex);
            }
        }
        ...
        {
            string deleteString =
                @"UPDATE [RoomBooking] SET [Last_Modified_At] = @Last_Modified_At, [Last_Modified_By] = @Last_Modified_By, [flag] = 'D' WHERE [Id] = @Id";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("RoomBookingDAO::Delete::Error", ex);
            }
        }
        ...
        {
            string selectString = @"Select * From [RoomBooking] Where [Id] = @Id AND (ISNULL(flag, '') = '')";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("RoomBookingDAO::SelectOne::Error", ex);
            }
        }
        ...
        {
            string selectAllString = "Select * From [RoomBooking] Where (ISNULL(flag, '') = '')";
            try
            {
            ...
            {
                throw new Exception("RoomBookingDAO::SelectAll::Error", ex);
            }
        }

        public static DataTable GetTemplateTable()
        {
            DataTable table = new DataTable("RoomBooking");
