...
{
    public class AdvertisementTypeDAO : BaseDAO
    {
        ...
        {
            string insertString = "Insert Into [AdvertisementType]" +
                                  "([Name],[Alias],[Detail],[Created_At],[Created_By],[Last_Modified_At],[Last_Modified_By],[flag]) " +
                                  "Values(@Name, @Alias, @Detail, @Created_At, @Created_By, @Last_Modified_At, @Last_Modified_By, @Flag) " +
            ...
            {
                throw new Exception("AdvertisementTypeDAO::Insert::Error", ex);
            }
        }
        ...
        {
            string updateString = @"Update [AdvertisementType] Set" +
                                  " [Name] = @Name, [Alias] = @Alias, [Detail] = @Detail, [Created_At] = @Created_At, [Created_By] = @Created_By, [Last_Modified_At] = @Last_Modified_At, [Last_Modified_By] = @Last_Modified_By, [flag] = @flag " +
            ...
            {
                throw new Exception("AdvertisementTypeDAO::Update::Error", ex);
            }
        }
        ...
        {
            string deleteString =
                @"UPDATE [AdvertisementType] SET [Last_Modified_At] = @Last_Modified_At, [Last_Modified_By] = @Last_Modified_By, [flag] = 'D' WHERE [Id] = @Id";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("AdvertisementTypeDAO::Delete::Error", ex);
            }
        }
        ...
        {
            string selectString = @"Select * From [AdvertisementType] Where [Id] = @Id AND (ISNULL(flag, '') = '')";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("AdvertisementTypeDAO::SelectOne::Error", ex);
            }
        }

        public static DataTable GetAdvertisementTypeByAlias(DataRow dataRow)
        {
            return GetAdvertisementTypeByAlias(null, dataRow);
        }

        public static DataTable GetAdvertisementTypeByAlias(SqlTransaction sqlTransaction, DataRow dataRow)
        {
            string selectString = @"SELECT * FROM [AdvertisementType] WHERE [Id] <> @Id AND [Alias] = @Alias AND (ISNULL(flag, '') = '')";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("AdvertisementTypeDAO::GetAdvertisementTypeByAlias::Error", ex);
            }
        }

        #region ViewGetAllAdvertisementType

        public static DataSet ViewGetAllAdvertisementType(DataSet dataSet)
        {
            return ViewGetAllAdvertisementType(null, dataSet);
        }

        public static DataSet ViewGetAllAdvertisementType(SqlTransaction sqlTransaction, DataSet dataSet)
        {
            ...
            string strQueryToCountRecord = "SELECT COUNT(*) "
                                           ...
                                           CommonDAO.SearchingQuery(dataSet.Tables[Constants.Paging.Direction.SearchingTableName],
                                                          AdvertisementConstants.Entities.AdvertisementType.SearchColumns,
                                                          ModuleConstants.ConnectorString.WHERE_STRING,
                                                          AdvertisementConstants.Entities.AdvertisementType.Name);

            //generate query string
            string strQueryToGetRecord = "SELECT * FROM ( "
                                         + "SELECT *, row_number() over(order by [Name]) RowNum FROM [AdvertisementType] "
                                         + CommonDAO.SearchingQuery(dataSet.Tables[Constants.Paging.Direction.SearchingTableName],
                                                          AdvertisementConstants.Entities.AdvertisementType.SearchColumns,
                                                          ModuleConstants.ConnectorString.WHERE_STRING,
                                                          AdvertisementConstants.Entities.AdvertisementType.Name)
        ...
        {
            string selectAllString = "Select * From [AdvertisementType] Where (ISNULL(flag, '') = '') ORDER BY [Name]";
            try
            {
            ...
            {
                throw new Exception("AdvertisementTypeDAO::SelectAll::Error", ex);
            }
        }

        public static DataTable GetTemplateTable()
        {
            DataTable table = new DataTable("AdvertisementType");
