...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class Configuration : ActiveRecord<Configuration>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Configuration", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("Configuration",schema);
			}
		}
		#endregion
