...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class AdvertisementLayout : ActiveRecord<AdvertisementLayout>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementLayout", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AdvertisementLayout",schema);
			}
		}
		#endregion
		...
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementLayoutCategoryCollection().Where(AdvertisementLayoutCategory.Columns.LayoutId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementLayoutZoneCollection AdvertisementLayoutZoneRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementLayoutZoneCollection().Where(AdvertisementLayoutZone.Columns.LayoutId, Id).Load();
		}
		#endregion
