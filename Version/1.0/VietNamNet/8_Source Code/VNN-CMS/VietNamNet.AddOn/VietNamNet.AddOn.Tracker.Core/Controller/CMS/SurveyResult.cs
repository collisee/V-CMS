...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class SurveyResult : ActiveRecord<SurveyResult>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SurveyResults", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("SurveyResults",schema);
			}
		}
		#endregion
