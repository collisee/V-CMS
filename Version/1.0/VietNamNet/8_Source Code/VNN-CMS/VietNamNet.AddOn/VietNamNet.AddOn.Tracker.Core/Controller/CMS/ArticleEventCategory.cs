...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	{	   
        ...
        /// </summary>
        /// <returns>ArticleEventCategoryCollection</returns>
		public ArticleEventCategoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ArticleEventCategory o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class ArticleEventCategory : ActiveRecord<ArticleEventCategory>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleEventCategory", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("ArticleEventCategory",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleEvent ArticleEvent
		{
			get { return VietNamNet.AddOn.Tracker.Core.CMS.ArticleEvent.FetchByID(this.ArticleEventId); }
