...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class Collaborator : ActiveRecord<Collaborator>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Collaborator", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("Collaborator",schema);
			}
		}
		#endregion
