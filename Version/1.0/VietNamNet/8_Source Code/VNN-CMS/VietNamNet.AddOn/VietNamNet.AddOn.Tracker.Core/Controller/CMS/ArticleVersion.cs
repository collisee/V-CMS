...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	{	   
        ...
        /// </summary>
        /// <returns>ArticleVersionCollection</returns>
		public ArticleVersionCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ArticleVersion o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class ArticleVersion : ActiveRecord<ArticleVersion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleVersion", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("ArticleVersion",schema);
			}
		}
		#endregion
