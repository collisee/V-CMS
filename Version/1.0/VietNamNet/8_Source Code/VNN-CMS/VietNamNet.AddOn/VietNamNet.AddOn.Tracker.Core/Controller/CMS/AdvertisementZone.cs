...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class AdvertisementZone : ActiveRecord<AdvertisementZone>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementZone", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AdvertisementZone",schema);
			}
		}
		#endregion
		...
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementLayoutZoneCollection().Where(AdvertisementLayoutZone.Columns.ZoneId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementZoneBlockCollection AdvertisementZoneBlockRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementZoneBlockCollection().Where(AdvertisementZoneBlock.Columns.ZoneId, Id).Load();
		}
		#endregion
