...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	{	   
        ...
        /// </summary>
        /// <returns>ArticleTypeCollection</returns>
		public ArticleTypeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ArticleType o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class ArticleType : ActiveRecord<ArticleType>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleType", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("ArticleType",schema);
			}
		}
		#endregion
		...
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleVersionCollection().Where(ArticleVersion.Columns.ArticleTypeId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleCollection ArticleRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleCollection().Where(Article.Columns.ArticleTypeId, Id).Load();
		}
		#endregion
