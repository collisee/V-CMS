...
{
	/// <summary>
	/// Strongly-typed collection for the AdvertisementType class.
	/// </summary>
    [Serializable]
	public partial class AdvertisementTypeCollection : ActiveList<AdvertisementType, AdvertisementTypeCollection>
	{	   
        ...
        /// </summary>
        /// <returns>AdvertisementTypeCollection</returns>
		public AdvertisementTypeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AdvertisementType o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AdvertisementType table.
	/// </summary>
	[Serializable]
	public partial class AdvertisementType : ActiveRecord<AdvertisementType>, IActiveRecord
	{
		...
		public AdvertisementType(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AdvertisementType(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AdvertisementType(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementType", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AdvertisementType",schema);
			}
		}
		#endregion
		...
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementItemCollection AdvertisementItemRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementItemCollection().Where(AdvertisementItem.Columns.TypeId, Id).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varName,string varAliasX,string varDetail,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
		...
		/// </summary>
		public static void Update(int varId,string varName,string varAliasX,string varDetail,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
			AdvertisementType item = new AdvertisementType();
