...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	{	   
        ...
        /// </summary>
        /// <returns>FunctionCollection</returns>
		public FunctionCollection Filter()
        {
	...
	/// </summary>
	[Serializable]
	public partial class Function : ActiveRecord<Function>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Function", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("Function",schema);
			}
		}
		#endregion
