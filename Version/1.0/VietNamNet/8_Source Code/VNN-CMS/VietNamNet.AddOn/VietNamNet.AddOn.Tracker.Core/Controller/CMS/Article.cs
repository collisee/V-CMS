...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class Article : ActiveRecord<Article>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Article", TableType.Table, DataService.GetInstance("VNN"));
				...
				TableSchema.TableColumn colvarShowComment = new TableSchema.TableColumn(schema);
				colvarShowComment.ColumnName = "ShowComment";
				colvarShowComment.DataType = DbType.Int32;
				colvarShowComment.MaxLength = 0;
				colvarShowComment.AutoIncrement = false;
				colvarShowComment.IsNullable = false;
				colvarShowComment.IsPrimaryKey = false;
				colvarShowComment.IsForeignKey = false;
				colvarShowComment.IsReadOnly = false;
				
						colvarShowComment.DefaultSetting = @"((1))";
				colvarShowComment.ForeignKeyTableName = "";
				schema.Columns.Add(colvarShowComment);
				...
				colvarAuthorId.IsReadOnly = false;
						...
						colvarAuthorId.DefaultSetting = @"((0))";
				...
				DataService.Providers["VNN"].AddSchema("Article",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.ShowComment); }
			set { SetColumnValue(Columns.ShowComment, value); }
		}
		...
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleEventItemCollection ArticleEventItemRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleEventItemCollection().Where(ArticleEventItem.Columns.ArticleEventId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleCategoryCollection ArticleCategoryRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleCategoryCollection().Where(ArticleCategory.Columns.ArticleId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleCommentCollection ArticleCommentRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleCommentCollection().Where(ArticleComment.Columns.ArticleId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleEventItemCollection ArticleEventItemRecordsFromArticle()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleEventItemCollection().Where(ArticleEventItem.Columns.ArticleId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleMediumCollection ArticleMedia()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleMediumCollection().Where(ArticleMedium.Columns.ArticleId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleVersionCollection ArticleVersionRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleVersionCollection().Where(ArticleVersion.Columns.ArticleId, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleContentType ArticleContentType
		{
			get { return VietNamNet.AddOn.Tracker.Core.CMS.ArticleContentType.FetchByID(this.ArticleContentTypeId); }
		...
		/// 
		/// </summary>
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleType ArticleType
		{
			get { return VietNamNet.AddOn.Tracker.Core.CMS.ArticleType.FetchByID(this.ArticleTypeId); }
		...
		public static void Insert(int varVersionId,string varStatus,int varArticleTypeId,int varArticleContentTypeId,string varName,string varTitle,string varUrl,int varCategoryId,int varPartitionId,string varSubTitle1,string varSubTitle2,string varSubTitle3,string varSubTitle4,string varSubTitle5,string varSubTitle6,string varImageLink,string varImageLink1,string varImageLink2,string varImageLink3,string varImageLink4,string varImageLink5,string varLead,string varDetail,DateTime varPublishDate,int varShowComment,int varAuthorId,string varAuthor,string varAuthorInfo,int varIsMember,int varTotalView,string varHistory,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
			...
			item.ShowComment = varShowComment;
        ...
        public static TableSchema.TableColumn ShowCommentColumn
        {
