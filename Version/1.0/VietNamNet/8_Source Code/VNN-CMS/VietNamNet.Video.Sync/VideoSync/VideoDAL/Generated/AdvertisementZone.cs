...
namespace VideoDAL
{
	...
	public partial class AdvertisementZone : ActiveRecord<AdvertisementZone>, IActiveRecord
	{
		...
		{
			return new VideoDAL.AdvertisementLayoutZoneCollection().Where(AdvertisementLayoutZone.Columns.ZoneId, Id).Load();
		}
		public VideoDAL.AdvertisementZoneBlockCollection AdvertisementZoneBlockRecords()
		{
			return new VideoDAL.AdvertisementZoneBlockCollection().Where(AdvertisementZoneBlock.Columns.ZoneId, Id).Load();
		}
		#endregion
