...
namespace VideoDAL
{
	...
	public partial class AdvertisementZoneBlock : ActiveRecord<AdvertisementZoneBlock>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementZoneBlock", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("AdvertisementZoneBlock",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public VideoDAL.AdvertisementBlock AdvertisementBlock
		{
			get { return VideoDAL.AdvertisementBlock.FetchByID(this.BlockId); }
