...
namespace VideoDAL
{
	...
	public partial class Group : ActiveRecord<Group>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Group", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("Group",schema);
			}
		}
		#endregion
		...
		{
			return new VideoDAL.CategoryPolicyCollection().Where(CategoryPolicy.Columns.GroupId, Id).Load();
		}
		public VideoDAL.GroupMemberCollection GroupMemberRecords()
		{
			return new VideoDAL.GroupMemberCollection().Where(GroupMember.Columns.GroupId, Id).Load();
		}
		public VideoDAL.PolicyCollection PolicyRecords()
		{
			return new VideoDAL.PolicyCollection().Where(Policy.Columns.GroupId, Id).Load();
		}
		#endregion
