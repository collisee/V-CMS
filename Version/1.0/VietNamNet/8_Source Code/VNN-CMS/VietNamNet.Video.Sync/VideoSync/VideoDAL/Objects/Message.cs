...
namespace VideoDAL
{
	...
	public partial class Message : ActiveRecord<Message>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Message", TableType.Table, DataService.GetInstance("VCMS"));
				...
				colvarMsgType.IsReadOnly = false;
						...
						colvarMsgType.DefaultSetting = @"((0))";
				...
				DataService.Providers["VCMS"].AddSchema("Message",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varMsgType,string varStatus,string varName,string varSubject,string varDetail,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
		...
		/// </summary>
		public static void Update(int varId,int varMsgType,string varStatus,string varName,string varSubject,string varDetail,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
			Message item = new Message();
