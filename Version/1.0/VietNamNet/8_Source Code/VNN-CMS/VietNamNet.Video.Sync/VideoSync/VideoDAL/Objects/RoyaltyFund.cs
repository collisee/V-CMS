...
namespace VideoDAL
{
	...
	public partial class RoyaltyFund : ActiveRecord<RoyaltyFund>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RoyaltyFund", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("RoyaltyFund",schema);
			}
		}
		#endregion
