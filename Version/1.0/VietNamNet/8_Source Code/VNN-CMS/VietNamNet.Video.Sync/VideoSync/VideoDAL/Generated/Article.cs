...
namespace VideoDAL
{
	...
	public partial class Article : ActiveRecord<Article>, IActiveRecord
	{
		...
		public VideoDAL.ArticleCategoryCollection ArticleCategoryRecords()
		{
			return new VideoDAL.ArticleCategoryCollection().Where(ArticleCategory.Columns.ArticleId, Id).Load();
		}
		public VideoDAL.ArticleCommentCollection ArticleCommentRecords()
		{
			return new VideoDAL.ArticleCommentCollection().Where(ArticleComment.Columns.ArticleId, Id).Load();
		}
		public VideoDAL.ArticleEventItemCollection ArticleEventItemRecords()
		{
			return new VideoDAL.ArticleEventItemCollection().Where(ArticleEventItem.Columns.ArticleId, Id).Load();
		}
		public VideoDAL.ArticleMediumCollection ArticleMedia()
		{
			return new VideoDAL.ArticleMediumCollection().Where(ArticleMedium.Columns.ArticleId, Id).Load();
		}
		public VideoDAL.ArticleVersionCollection ArticleVersionRecords()
		{
			return new VideoDAL.ArticleVersionCollection().Where(ArticleVersion.Columns.ArticleId, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public VideoDAL.ArticleContentType ArticleContentType
		{
			get { return VideoDAL.ArticleContentType.FetchByID(this.ArticleContentTypeId); }
		...
		/// 
		/// </summary>
		public VideoDAL.ArticleType ArticleType
		{
			get { return VideoDAL.ArticleType.FetchByID(this.ArticleTypeId); }
