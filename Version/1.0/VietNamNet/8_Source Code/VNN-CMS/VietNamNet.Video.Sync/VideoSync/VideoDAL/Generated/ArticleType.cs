...
namespace VideoDAL
{
	...
	public partial class ArticleType : ActiveRecord<ArticleType>, IActiveRecord
	{
		...
		{
			return new VideoDAL.ArticleCollection().Where(Article.Columns.ArticleTypeId, Id).Load();
		}
		public VideoDAL.ArticleVersionCollection ArticleVersionRecords()
		{
			return new VideoDAL.ArticleVersionCollection().Where(ArticleVersion.Columns.ArticleTypeId, Id).Load();
		}
		#endregion
