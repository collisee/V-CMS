...
namespace VideoDAL
{
	...
	public partial class ModuleX : ActiveRecord<ModuleX>, IActiveRecord
	{
		...
		public VideoDAL.FunctionCollection FunctionRecords()
		{
			return new VideoDAL.FunctionCollection().Where(Function.Columns.ModuleId, Id).Load();
		}
		public VideoDAL.MenuCollection MenuRecords()
		{
			return new VideoDAL.MenuCollection().Where(Menu.Columns.ModuleId, Id).Load();
		}
		public VideoDAL.PolicyCollection PolicyRecords()
		{
			return new VideoDAL.PolicyCollection().Where(Policy.Columns.ModuleId, Id).Load();
		}
		#endregion
