...
{
	/// <summary>
	/// Strongly-typed collection for the AdvertisementLayout class.
	/// </summary>
    [Serializable]
	public partial class AdvertisementLayoutCollection : ActiveList<AdvertisementLayout, AdvertisementLayoutCollection>
	{	   
		public AdvertisementLayoutCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AdvertisementLayoutCollection</returns>
		public AdvertisementLayoutCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AdvertisementLayout o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AdvertisementLayout table.
	/// </summary>
	[Serializable]
	public partial class AdvertisementLayout : ActiveRecord<AdvertisementLayout>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AdvertisementLayout()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AdvertisementLayout(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AdvertisementLayout(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AdvertisementLayout(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementLayout", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("AdvertisementLayout",schema);
			}
		}
		#endregion
		...
		public VideoDAL.AdvertisementLayoutCategoryCollection AdvertisementLayoutCategoryRecords()
		{
			return new VideoDAL.AdvertisementLayoutCategoryCollection().Where(AdvertisementLayoutCategory.Columns.LayoutId, Id).Load();
		}
		public VideoDAL.AdvertisementLayoutZoneCollection AdvertisementLayoutZoneRecords()
		{
			return new VideoDAL.AdvertisementLayoutZoneCollection().Where(AdvertisementLayoutZone.Columns.LayoutId, Id).Load();
		}
		#endregion
