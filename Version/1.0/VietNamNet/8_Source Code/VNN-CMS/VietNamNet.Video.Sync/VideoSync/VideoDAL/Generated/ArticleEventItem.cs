...
namespace VideoDAL
{
	...
	public partial class ArticleEventItem : ActiveRecord<ArticleEventItem>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleEventItem", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("ArticleEventItem",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a ArticleEvent ActiveRecord object related to this ArticleEventItem
		/// 
		/// </summary>
		public VideoDAL.ArticleEvent ArticleEvent
		{
			get { return VideoDAL.ArticleEvent.FetchByID(this.ArticleEventId); }
