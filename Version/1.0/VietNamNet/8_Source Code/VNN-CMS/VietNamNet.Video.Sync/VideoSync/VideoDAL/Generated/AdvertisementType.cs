...
namespace VideoDAL
{
	...
	public partial class AdvertisementType : ActiveRecord<AdvertisementType>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementType", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("AdvertisementType",schema);
			}
		}
		#endregion
		...
		public VideoDAL.AdvertisementItemCollection AdvertisementItemRecords()
		{
			return new VideoDAL.AdvertisementItemCollection().Where(AdvertisementItem.Columns.TypeId, Id).Load();
		}
		#endregion
