...
<%@ Control Language="C#" AutoEventWireup="true" Codebehind="PanelMostRead.ascx.cs"
  Inherits="VietNamNet.Websites.Clip.UserControls.Homepage.PanelMostRead" %>
    ...
    <div class="thongke_list mostread-item">
      <ul>
        <asp:Repeater ID="rptMostRead" runat="server">
          <ItemTemplate>
            <li class="thongke_item"><a href="/vn/<%#DataBinder.Eval(Container.DataItem, "Url") %><%#DataBinder.Eval(Container.DataItem, "Id") %>/<%#WebsitesUtils.BuildLink(DataBinder.Eval(Container.DataItem, "Name").ToString()) %>.html">
