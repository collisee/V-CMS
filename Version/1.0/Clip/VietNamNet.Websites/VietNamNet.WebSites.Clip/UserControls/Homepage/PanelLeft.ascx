<%@ Control Language="C#" AutoEventWireup="true" Codebehind="PanelLeft.ascx.cs" Inherits="VietNamNet.Websites.Clip.UserControls.Homepage.PanelLeft" %>
...
<div class="home5left">
  ...
  <uc:PanelCategory ID="PanelCategory1" runat="server" CategoryAlias="xa-hoi" SubCategoryName="Pháp luật;Lao động;Đời sống;Blog Việt" SubCategoryLink="/vn/xa-hoi/phap-luat/index.html;/vn/xa-hoi/phap-luat/index.html;/vn/xa-hoi/phap-luat/index.html;/vn/xa-hoi/phap-luat/index.html" />
  ...
  <uc:PanelCategory ID="PanelCategory5" runat="server" CategoryAlias="the-thao" SubCategoryName="BBC Giải bóng đá Premiership" SubCategoryLink="/vn/xa-hoi/index.html" Visible="false" />
  <uc:PanelAdvB_3 ID="PanelAdvB_3_1" runat="server" />
  <uc:PanelCategory ID="PanelCategory6" runat="server" CategoryAlias="chuyen-trang-2sao" />
