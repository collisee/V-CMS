<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelCateContentViewDate.ascx.cs" Inherits="VietNamNet.Websites.Clip.UserControls.Categories.PanelCateContentViewDate" %>
