...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="Live.aspx.cs" Inherits="VietNamNet.WebSites.Clip.Live" %>
...
<%@ Register Src="~/UserControls/PanelLiveTV.ascx" TagName="PanelLiveTV"
  TagPrefix="uc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div id="home4">
    <!-- Tieu Diem -->
    <div id="home4_1">
      <uc:PanelLiveTV ID="PanelLiveTV1" runat="server" CategoryAlias="clip-mobile" />
  ...
  <div id="home5">
    <div class="home5left">
      <!--qc center-->
      <uc:PanelCate3gContent ID="PanelCate3gContent1" runat="server" CategoryAlias="clip-mobile" />
    </div>
  ...
  <uc:PanelAdvertisement ID="PanelAdvertisement1" runat="server" CategoryAlias="clip-mobile" />
</asp:Content>
