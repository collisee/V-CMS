    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!IsPostBack)
      {
        ...
        if (dtArticle != null && dtArticle.Rows.Count > 0)
        {
          ...
          //Get more article
          int categoryId =
            Utilities.ParseInt(dtArticle.Rows[0][WebsitesConstants.Entity.WebsitesObject.FieldName.CategoryId]);
          int partitionId =
            Utilities.ParseInt(dtArticle.Rows[0][WebsitesConstants.Entity.WebsitesObject.FieldName.PartitionId]);
