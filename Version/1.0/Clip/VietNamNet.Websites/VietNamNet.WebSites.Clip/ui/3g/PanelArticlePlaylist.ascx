<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelArticlePlaylist.ascx.cs" Inherits="VietNamNet.Websites.Clip.ui._3g.PanelArticlePlaylist" %>
<div class="clip_hot">
...
<div class="clip_static ">
    ...
    <div class="clip_rate">
        ...
        <div class="rate_star1">
            <img src="/images/blank.gif" width="18px" height="34px" /></div>
        <div class="rate_star1">
            <img src="/images/blank.gif" width="18px" height="34px" /></div>
        <div class="rate_star1">
            <img src="/images/blank.gif" width="18px" height="34px" /></div>
    ...
    <div class="clip_sentmail">
        <a href="#" class="sentmail_link">
            <img src="/images/blank.gif" width="130" height="39" /></a>
    </div>
    <div class="clip_face">
        <a href="#">
            <img src="/images/blank.gif" width="70" height="42" /></a>
    </div>
</div>
