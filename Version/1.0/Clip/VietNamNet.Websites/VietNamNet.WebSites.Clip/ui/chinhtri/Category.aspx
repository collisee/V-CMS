<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" Codebehind="Category.aspx.cs"
    Inherits="VietNamNet.Websites.Clip.ui.chinhtri.Category" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelCateHotNews CategoryAlias="chinh-tri" FirstIndexRecord="2" LastIndexRecord="4"
                ID="PanelCateHotNews1" runat="server" />
            <uc:PanelCateCenterPoint CategoryAlias="chinh-tri" FirstIndexRecord="1" LastIndexRecord="3"
                ID="PanelCateCenterPoint1" runat="server" />
            <div class="clear">
                ,</div>
            <uc:PanelCateHotSlide CategoryAlias="chinh-tri" FirstIndexRecord="5" LastIndexRecord="9"
        ...
        <div class="home5right">
            <div class="home5_right">
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">
                            <uc:PanelCateBox1 CategoryAlias="chinh-tri-dong-su-kien" ID="PanelCateBox1_2" runat="server" />
                            <uc:PanelCateBox1 CategoryAlias="chinh-tri-tieu-diem" ID="PanelCateBox1_1" runat="server" />
