    function initVideoPlayer(){
	    ...
	    swfobject.embedSWF("/lib/player.swf", 'mediaplayer', 354, 230, "9.0.115", false, flashvars, params, attributes);
    };
    ...
    function setFocus(index) {
        $('#video-list .clip-item').removeClass('box-focus');
        $($('#video-list .clip-item').get(index)).addClass('box-focus');
    }
