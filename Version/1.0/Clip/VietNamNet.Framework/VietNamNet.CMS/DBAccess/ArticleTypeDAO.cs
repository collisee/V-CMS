...
{
    public class ArticleTypeDAO : BaseDAO
    {
        ...
        {
            string insertString = "Insert Into [ArticleType]" +
            ...
            {
                throw new Exception("ArticleTypeDAO::Insert::Error", ex);
            }
        }
        ...
        {
            string updateString = @"Update [ArticleType] Set" +
            ...
            {
                throw new Exception("ArticleTypeDAO::Update::Error", ex);
            }
        }
        ...
        {
            string deleteString =
                @"UPDATE [ArticleType] SET [Last_Modified_At] = @Last_Modified_At, [Last_Modified_By] = @Last_Modified_By, [flag] = 'D' WHERE [Id] = @Id";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("ArticleTypeDAO::Delete::Error", ex);
            }
        }
        ...
        {
            string selectString = @"Select * From [ArticleType] Where [Id] = @Id AND (ISNULL(flag, '') = '')";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("ArticleTypeDAO::SelectOne::Error", ex);
            }
        }
        ...
        {
            string selectAllString = "Select * From [ArticleType] Where (ISNULL(flag, '') = '')";
            try
            {
            ...
            {
                throw new Exception("ArticleTypeDAO::SelectAll::Error", ex);
            }
        }

        #region ViewGetAllArticleType

        public static DataSet ViewGetAllArticleType(DataSet dataSet)
        {
            return ViewGetAllArticleType(null, dataSet);
        }

        public static DataSet ViewGetAllArticleType(SqlTransaction sqlTransaction, DataSet dataSet)
        {
            ...
            string strQueryToCountRecord = "SELECT COUNT(*) "
                                           ...
                                           CommonDAO.SearchingQuery(dataSet.Tables[Constants.Paging.Direction.SearchingTableName],
                                                          CMSConstants.Entities.ArticleType.SearchColumns,
                                                          ModuleConstants.ConnectorString.WHERE_STRING,
                                                          CMSConstants.Entities.ArticleType.Name);

            //generate query string
            string strQueryToGetRecord = "SELECT * FROM ( "
                                         + "SELECT *, row_number() over(order by [Name]) RowNum FROM [ArticleType] "
                                         + CommonDAO.SearchingQuery(dataSet.Tables[Constants.Paging.Direction.SearchingTableName],
                                                          CMSConstants.Entities.ArticleType.SearchColumns,
                                                          ModuleConstants.ConnectorString.WHERE_STRING,
                                                          CMSConstants.Entities.ArticleType.Name)
        ...
        {
            DataTable table = new DataTable("ArticleType");
