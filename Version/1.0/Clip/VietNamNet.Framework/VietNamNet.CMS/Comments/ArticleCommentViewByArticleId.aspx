<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="ArticleCommentViewByArticleId.aspx.cs" Inherits="VietNamNet.CMS.Comments.ArticleCommentViewByArticleId" %>
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Trạng thái" UniqueName="TemplateColumn">
                            <HeaderStyle Font-Bold="True" />
                            <ItemTemplate>
                                <a href="ArticleCommentViewByStatus.aspx?Status=<%#DataBinder.Eval(Container.DataItem, "Status")%>">
                                    <%#DataBinder.Eval(Container.DataItem, "Status")%>
                                </a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Bài viết" UniqueName="TemplateColumn">
                            <HeaderStyle Font-Bold="True" />
                            <ItemTemplate>
                                ...
                                <a href="ArticleCommentViewByArticleId.aspx?AId=<%#DataBinder.Eval(Container.DataItem, "ArticleId")%>">
                                    <img alt="Tìm theo bài viết" title="Tìm theo bài viết" src="/Images/SmallIcon/75.png" />
                                </a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridBoundColumn DataField="Name" HeaderText="Họ tên" UniqueName="Name">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Email" HeaderText="Email" UniqueName="Email">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Phone" HeaderText="Số điện thoại" UniqueName="Phone">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                            ConfirmText="Bạn c&#243; chắc chắn muốn X&#243;a phản hồi n&#224;y?" ConfirmTitle="X&#243;a"
