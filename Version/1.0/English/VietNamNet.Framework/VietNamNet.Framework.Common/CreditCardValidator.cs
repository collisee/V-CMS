...
namespace VietNamNet.Framework.Common
{
    ...
    public enum CardType
    {
        ...
        JCB = 0x0040,
        Unknown = 0x0080,
        All = Amex | DinersClub | Discover | Discover |
              enRoute | JCB | MasterCard | VISA
    }
    ...
    public class CreditCardValidator : BaseValidator
    {
        ...
        private TextBox _creditCardTextBox;
        ...
        {
            get { return _validateCardType; }
            set { _validateCardType = value; }
        }

        public string AcceptedCardTypes
        {
            get { return _cardTypes.ToString(); }
            set { _cardTypes = (CardType) Enum.Parse(typeof (CardType), value, false); }
        }
        ...
        protected override bool ControlPropertiesValid()
        {
            ...
            if (null != ctrl)
            {
                if (ctrl is TextBox) // ensure its a text box
                {
                    _creditCardTextBox = (TextBox) ctrl; // set the member variable
