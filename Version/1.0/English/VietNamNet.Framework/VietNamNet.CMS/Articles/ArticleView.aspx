<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="ArticleView.aspx.cs" Inherits="VietNamNet.CMS.Articles.ArticleView" %>
            ...
            <Items>
				...
				<telerik:RadToolBarButton Value="searchStatusComboBoxButton" CommandName="searchStatusComboBox">
				    <ItemTemplate>
                        ...
                        <telerik:RadComboBox ID="cmbStatus" runat="server" EmptyMessage="Chọn trạng thái..." Width="100px">
                            <Items>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Author" HeaderText="Tác giả" UniqueName="Author">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="TotalView" HeaderText="Số lượt xem" UniqueName="TotalView" DataFormatString="{0:#,##0}">
                            <HeaderStyle Font-Bold="True" Width="100px" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="URL">
                            ...
                            <ItemTemplate>
                                <%#Utilities.GetArticleUrl(DataBinder.Eval(Container.DataItem, "Url"), DataBinder.Eval(Container.DataItem, "Id"), DataBinder.Eval(Container.DataItem, "Name"))%>
                            </ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Nhuận bút">
                            ...
                            <ItemTemplate>
                                <asp:PlaceHolder ID="plhRoyalty" runat="server" Visible='<%#Utilities.StringCompare(HttpUtility.HtmlDecode(DataBinder.Eval(Container.DataItem, "Status").ToString()), CMSConstants.ArticleStatus.Published) %>'>
                                    <a href="/Royalty/FundsManager/FundByArticle.aspx?DocId=<%#DataBinder.Eval(Container.DataItem, "Id")%>" target="_blank">
                                        <img alt="Chấm Nhuận bút" title="Chấm Nhuận bút" src="/Images/LargeIcon/paste.png" height="16" />
                                    </a>
                                </asp:PlaceHolder>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" Font-Bold="True" Width="80px" />
