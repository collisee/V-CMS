...
namespace VietNamNet.CMS.Comments
{
    public partial class ArticleCommentEdit : BasePage
    {
        ...
        private void BindData()
        {
            ...
            //logging
            SystemLogging.Info("Create Comment");
        }
        ...
        private void BindData(ArticleComment o)
        {
            ...
            //logging
            SystemLogging.Info("Display Comment", string.Format("{0} - {1}", o.Id, o.Subject));
        }
            ...
            if (GetData(helper.ValueObject))
            {
                ...
                switch (status)
                {
                    case CMSConstants.ArticleStatus.Draft:
                        //logging
                        SystemLogging.Info("Save Comment", txtSubject.Text);
                    ...
                    case CMSConstants.ArticleStatus.Published:
                        //logging
                        SystemLogging.Info("Publish Comment", txtSubject.Text);
                    ...
                    case CMSConstants.ArticleStatus.Rejected:
                        //logging
                        SystemLogging.Info("Reject Comment", txtSubject.Text);
                    ...
                    case CMSConstants.ArticleStatus.Stopped:
                        //logging
                        SystemLogging.Info("Stop Comment", txtSubject.Text);
