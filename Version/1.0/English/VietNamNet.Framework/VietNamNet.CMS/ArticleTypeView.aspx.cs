...
{
    public partial class ArticleTypeView : BasePageView
    {
        ...
        private void Initialize()
        {
            ...
            ServiceName = CMSConstants.Services.ArticleTypeManager.Name;
            ActionName = CMSConstants.Services.ArticleTypeManager.Actions.ViewGetAllArticleType;
        }
        ...
        protected void radToolBarDefault_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            ...
            switch (((RadToolBarButton)e.Item).CommandName)
            {
                case Constants.CommandNames.AddNew:
                    Utilities.Redirect(CMSConstants.FormNames.CMS.ArticleTypeEdit);
                    break;
        ...
        protected override void radGridDefault_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            {
                Utilities.Redirect(CMSConstants.FormNames.CMS.ArticleTypeDisplay,
