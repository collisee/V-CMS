<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Codebehind="WebLink.aspx.cs"
  Inherits="VietNamNet.Websites.English.WebLink" %>

<%@ Register Src="UserControls/PanelWebLink.ascx" TagName="PanelWebLink" TagPrefix="uc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="home-body">
    <div class="body680">
      ...
      <uc:PanelWebLink ID="PanelWebLink1" runat="server" />
