<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelContentVideo.ascx.cs" Inherits="VietNamNet.Websites.English.UserControls.News.PanelContentVideo" %>
...
<script type="text/javascript">
    function initVideoPlayer(){
        ...
        swfobject.embedSWF("/Lib/player.swf", 'videoPlayer', 330, 215, "9.0.115", false, flashvars, params, attributes);
    }
