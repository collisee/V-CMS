...
namespace VietNamNet.CMS.Articles.UserControls
{
    public partial class PanelArticleMedia : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (EditOption == 0)
                {
                    ...
                    radGridMedia.Columns[radGridMedia.Columns.Count - 1].Visible = false;
                    radGridMedia.Columns[radGridMedia.Columns.Count - 2].Visible = false;
                    radGridMedia.Columns[radGridMedia.Columns.Count - 3].Visible = true;
        ...
        protected void btnAddMedia_Click(object sender, EventArgs e)
        {
            ...
            mediaFile[CMSConstants.Entities.ArticleMedia.FieldName.MediaType] = GetFileType(txtMedia.Text.Trim());
            mediaFile[CMSConstants.Entities.ArticleMedia.FieldName.FileLink] = txtMedia.Text.Trim();
            mediaFile[CMSConstants.Entities.ArticleMedia.FieldName.Thumbnail] = txtThumbnail.Text.Trim();
            ...
            mediaFile[CMSConstants.Entities.ArticleMedia.FieldName.Created_By] = Utilities.ParseInt(Session[Constants.Session.USER_ID]);
            mediaFile[CMSConstants.Entities.ArticleMedia.FieldName.Last_Modified_At] = DateTime.Now;
            mediaFile[CMSConstants.Entities.ArticleMedia.FieldName.Last_Modified_By] = Utilities.ParseInt(Session[Constants.Session.USER_ID]);
