...
{
    public partial class CollaboratorEdit : BasePage
    {
        ...
        private void BindData(Collaborator o)
        {
            txtName.Text = o.Name;
            txtDetail.Text = o.Detail;
        }

        private void GetData(Collaborator o)
        {
            int docId = Utilities.ParseInt(Request.Params[Constants.ParameterName.DOC_ID]);
            o.Id = docId;
        ...
        private void DoSave()
        {
            ...
            Utilities.Redirect(CMSConstants.FormNames.CMS.CollaboratorDisplay, helper.ValueObject.Id.ToString(), true);
        }
        ...
        protected void radToolBarDefault_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            ...
            switch (((RadToolBarButton)e.Item).CommandName)
            {
                ...
                case Constants.CommandNames.GoBacktoView:
                    Utilities.GoBackToView(CMSConstants.FormNames.CMS.CollaboratorView);
                    break;
                default:
                    break;
            }
