...
namespace VietNamNet.Framework.ImageUtility
{
    ...
    public class ImageUtils
    {
        ...
        public static bool Crop(Image img, int width, int height, string fileName)
        {
            try
            {
                Image ret = Crop(img, width, height, AnchorPosition.Center);
                if (ret != null)
                {
                    ret.Save(fileName);
                    return true;
        ...
        public static bool ResizePercent(Image img, int percent, string fileName)
        {
            try
            {
                Image ret = ResizePercent(img, percent);
                if (ret != null)
                {
                    ret.Save(fileName);
                    return true;
        ...
        public static bool ResizeFixed(Image img, int width, int height, string fileName)
        {
            try
            {
                Image ret = ResizeFixed(img, width, height);
                if (ret != null)
                {
                    ret.Save(fileName);
                    return true;
        ...
        public static bool Thumbnail(Image img, int width, int height, bool keepScale, string fileName)
        {
            try
            {
                Image ret = Thumbnail(img, width, height, keepScale);
                if (ret != null)
                {
                    ret.Save(fileName);
                    return true;
