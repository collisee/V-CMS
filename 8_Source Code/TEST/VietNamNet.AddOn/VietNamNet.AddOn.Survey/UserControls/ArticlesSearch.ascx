                ...
                <MasterTableView ClientDataKeyNames="Id,Name" DataKeyNames="Id,Name" GroupLoadMode="Client"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="#" HeaderStyle-Width="50" > 
                            <ItemTemplate>
                                <asp:LinkButton ID="cmdSelect" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Id") %>' CommandName="Select" OnClientClick="selectTab('tConfig');" ToolTip="Chọn Tin bài"><img src="/Images/LargeIcon/add.png" width="16px" />222</asp:LinkButton>&nbsp;&nbsp;
