...
namespace VietNamNet.AddOn.SurveyModule.DAL
{
	...
	public partial class Survey : ActiveRecord<Survey>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Surveys", TableType.Table, DataService.GetInstance("VietNamNet_Surveys"));
				...
				DataService.Providers["VietNamNet_Surveys"].AddSchema("Surveys",schema);
			}
		}
		#endregion
		...
		public VietNamNet.AddOn.SurveyModule.DAL.SurveyOptionCollection SurveyOptions()
		{
			return new VietNamNet.AddOn.SurveyModule.DAL.SurveyOptionCollection().Where(SurveyOption.Columns.SurveyId, SurveyId).Load();
		}
		public VietNamNet.AddOn.SurveyModule.DAL.SurveyPublishCollection SurveyPublishs()
		{
			return new VietNamNet.AddOn.SurveyModule.DAL.SurveyPublishCollection().Where(SurveyPublish.Columns.SurveyId, SurveyId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varQuestion,string varTags,string varOptionType,string varNotes,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiOn,bool varIsDeleted,bool varIsActive,byte? varStatus)
		{
