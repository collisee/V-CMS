...
namespace VietNamNet.AddOn.SurveyModule.DAL
{
	...
	public partial class SurveyPublish : ActiveRecord<SurveyPublish>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SurveyPublishs", TableType.Table, DataService.GetInstance("VietNamNet_Surveys"));
				...
				DataService.Providers["VietNamNet_Surveys"].AddSchema("SurveyPublishs",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a Survey ActiveRecord object related to this SurveyPublish
		/// 
		/// </summary>
