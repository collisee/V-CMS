<%@ Page MasterPageFile="~/Popup.Master" Language="C#" AutoEventWireup="true" CodeBehind="PopupSurveyAdd2Article.aspx.cs" Inherits="VietNamNet.AddOn.Survey.PopupSurveyAdd2Article" Title="Đưa Bình chọn vào Tin bài" %>

<%@ Register Src="UserControls/ArticlesSearch.ascx" TagName="ArticlesSearch" TagPrefix="uc1" %>
     ...
     <telerik:RadAjaxManager ID="radAjaxManager1" runat="server" DefaultLoadingPanelID="radAjaxLoadingPanel1">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="radToolBarDefault">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="lblMessage" /> 
                      <telerik:AjaxUpdatedControl ControlID="pnArticleInfo" />  
                </UpdatedControls>
            </telerik:AjaxSetting>  
              <telerik:AjaxSetting AjaxControlID="pnArticleInfo">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="pnArticleInfo" />  
                </UpdatedControls>
            </telerik:AjaxSetting> 
          ...
          <p class="rpCheckBoxPanel">  
            <telerik:RadTabStrip  ID="RadTabStrip1" runat="server"   MultiPageID="RadMultiPage1"
                ...
                <Tabs>
                    ...
                    <telerik:RadTab Text="Thông tin Tin bài" runat="server"  Value="tSearchInfo"></telerik:RadTab>
            ...
            <telerik:RadMultiPage  ID="RadMultiPage1" runat="server"  SelectedIndex="1" CssClass="multiPage">
                ...
                <telerik:RadPageView ID="pwArticleInfo" runat="server" CssClass="pageViewEducation"> 
                    <asp:Panel runat="server" ID="pnArticleInfo">
                                <uc1:ArticlesSearch ID="articlesSearch" runat="server" />
                      </asp:Panel>                  
                </telerik:RadPageView>
