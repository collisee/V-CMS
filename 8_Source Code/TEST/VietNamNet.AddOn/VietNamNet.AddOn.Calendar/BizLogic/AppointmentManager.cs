...
{
    /// <summary>
    /// Summary description for AppointmentManager.
    /// </summary>
    public class AppointmentManager : Facade
    {
        ...
        {
            if (Utilities.ParseInt(param.RawData.Tables[0].Rows[0][CalendarConstants.Entities.Appointment.FieldName.Id]) == 0)
            {
                AppointmentDAO.Insert(param.RawData.Tables[0].Rows[0]);
            }
            else
            {
                AppointmentDAO.Update(param.RawData.Tables[0].Rows[0]);
            }
        }
        ...
        {
            AppointmentDAO.Delete(param.RawData.Tables[0].Rows[0]);
        }
        ...
        {
            DataTable dt = AppointmentDAO.SelectOne(param.RawData.Tables[0].Rows[0]);
        ...
        {
            DataTable dt = AppointmentDAO.SelectAll();
            param.RawData.Tables.Clear();
            param.RawData.Tables.Add(dt.Copy());
        }
