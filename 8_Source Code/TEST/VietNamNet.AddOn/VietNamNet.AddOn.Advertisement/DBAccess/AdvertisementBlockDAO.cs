...
{
    public class AdvertisementBlockDAO : BaseDAO
    {
        ...
        {
            string insertString = "Insert Into [AdvertisementBlock]" +
                                  "([Name],[Detail],[Mode],[TimeDelay],[Width],[Height],[Created_At],[Created_By],[Last_Modified_At],[Last_Modified_By],[flag]) " +
                                  "Values(@Name, @Detail, @Mode, @TimeDelay, @Width, @Height, @Created_At, @Created_By, @Last_Modified_At, @Last_Modified_By, @Flag) " +
                ...
                SqlParameter[] paramArray = new SqlParameter[]
                    {
                        ...
                        CreateSqlPrameter("@TimeDelay", SqlDbType.Int, 0, ParameterDirection.Input),
            ...
            {
                throw new Exception("AdvertisementBlockDAO::Insert::Error", ex);
            }
        }
        ...
        {
            string updateString = @"Update [AdvertisementBlock] Set" +
                                  " [Name] = @Name, [Detail] = @Detail, [Mode] = @Mode, [TimeDelay] = @TimeDelay, [Width] = @Width, [Height] = @Height, [Created_At] = @Created_At, [Created_By] = @Created_By, [Last_Modified_At] = @Last_Modified_At, [Last_Modified_By] = @Last_Modified_By, [flag] = @flag " +
            ...
            {
                throw new Exception("AdvertisementBlockDAO::Update::Error", ex);
            }
        }
        ...
        {
            string deleteString =
                @"UPDATE [AdvertisementBlock] SET [Last_Modified_At] = @Last_Modified_At, [Last_Modified_By] = @Last_Modified_By, [flag] = 'D' WHERE [Id] = @Id";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("AdvertisementBlockDAO::Delete::Error", ex);
            }
        }
        ...
        {
            string selectString = @"Select * From [AdvertisementBlock] Where [Id] = @Id AND (ISNULL(flag, '') = '')";
            try
            {
                SqlParameter[] paramArray = new SqlParameter[]
                    {
            ...
            {
                throw new Exception("AdvertisementBlockDAO::SelectOne::Error", ex);
            }
        }

        #region ViewGetAllAdvertisementBlock

        public static DataSet ViewGetAllAdvertisementBlock(DataSet dataSet)
        {
            return ViewGetAllAdvertisementBlock(null, dataSet);
        }

        public static DataSet ViewGetAllAdvertisementBlock(SqlTransaction sqlTransaction, DataSet dataSet)
        {
            ...
            string strQueryToCountRecord = "SELECT COUNT(*) "
                                           ...
                                           CommonDAO.SearchingQuery(dataSet.Tables[Constants.Paging.Direction.SearchingTableName],
                                                          AdvertisementConstants.Entities.AdvertisementBlock.SearchColumns,
                                                          ModuleConstants.ConnectorString.WHERE_STRING,
                                                          AdvertisementConstants.Entities.AdvertisementBlock.Name);
        ...
        {
            string selectAllString = "Select * From [AdvertisementBlock] Where (ISNULL(flag, '') = '') ORDER BY [Name]";
            try
            {
            ...
            {
                throw new Exception("AdvertisementBlockDAO::SelectAll::Error", ex);
            }
        }

        public static DataTable GetTemplateTable()
        {
            DataTable table = new DataTable("AdvertisementBlock");
            table.Columns.Add("Id");
            table.Columns.Add("Name");
            table.Columns.Add("Detail");
            table.Columns.Add("Mode");
            table.Columns.Add("TimeDelay");
