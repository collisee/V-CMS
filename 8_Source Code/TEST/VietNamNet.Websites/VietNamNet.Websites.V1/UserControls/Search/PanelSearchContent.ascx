    ...
    <table>
        ...
        <tr>
            ...
            <td><select id="scat" name="scat"  >
                    ...
                    <option value="kinh-te" <%=CategoryAlias==""?"selected":"" %>>Kinh tế</option>
    ...
    <div class="item">
                <div class="item_img boder-img">
                    <a href="/vn/<%# DataBinder.Eval(Container.DataItem, "URL")%><%#DataBinder.Eval(Container.DataItem, "Id")%>/<%#WebsitesUtils.BuildLink(DataBinder.Eval(Container.DataItem, "Name").ToString()) %>.html">                        
                         <img src="http://203.162.71.133:8189/thumb/view.jpgx?file=<%#DataBinder.Eval(Container.DataItem, "ImageLink")%>&width=142&height=80" height="80" width="142" />
                    </a>                        
                </div>
                <a class="item_link" href="/vn/<%# DataBinder.Eval(Container.DataItem, "URL")%><%#DataBinder.Eval(Container.DataItem, "Id")%>/<%#WebsitesUtils.BuildLink(DataBinder.Eval(Container.DataItem, "Name").ToString()) %>.html"><%#DataBinder.Eval(Container.DataItem, "Name")%></a>
                <div class="lead">
