...
{
    public partial class PaneSurvey : System.Web.UI.UserControl
  {
    ...
    private void PopularItem()
    {
        if (ArticleId != 0)
        {
            lblItem.Text = "<div id=\"" + this.ClientID + "\" survey=\"true\" articleId=\"" + ArticleId + "\"></div>";
        }
        else if (CategoryAlias!="")
        {
            lblItem.Text = "<div id=\""+this.ClientID+"\" survey=\"true\" categoryalias=\"" + CategoryAlias + "\"></div>";
        }
