...
{
  public partial class PanelBigCateBox : System.Web.UI.UserControl
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (dt != null && dt.Rows.Count > 0)
      {
        ...
        if (dtArticles != null && dt.Rows.Count > 0)
        {
          ...
          if (dtArticles.Rows.Count > 1) // top 2 - 4
          {
            DataTable dtArticles3 = dtArticles.Copy();
            dtArticles3.Rows.RemoveAt(0); //remove 1            
            while (dtArticles3.Rows.Count > 3) dtArticles3.Rows.RemoveAt(3);

            rptTop3.DataSource = dtArticles3;
            rptTop3.DataBind();
          }

          if (dtArticles.Rows.Count > 4) // top 5 - 6
          {
