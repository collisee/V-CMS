  ...
  public partial class PanelCateContent : UserControl
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (dt != null && dt.Rows.Count > 0)
      {
        ...
        hplPrev.NavigateUrl = string.Format(categoryUrl, "trang" + (PageNumber - 1), "index");
        hplNext.NavigateUrl = string.Format(categoryUrl, "trang" + (PageNumber + 1), "index");
        ...
        helperArticles.ValueObject.FirstIndexRecord = ((PageNumber - 1) * pageSize + 1) + 9;
        helperArticles.ValueObject.LastIndexRecord = (PageNumber * pageSize) + 9;
