...
{
  public partial class PanelTinBongda : System.Web.UI.UserControl
  {
      ...
      if (dt != null && dt.Rows.Count > 0)
      {
        ...
        if (dtArticles != null && dt.Rows.Count > 0)
        {
          if (dtArticles.Rows.Count > 0) //top 3
          {
            ...
            while (dtArticles1.Rows.Count > 2) dtArticles1.Rows.RemoveAt(2);

            rptTop3.DataSource = dtArticles1;
            rptTop3.DataBind();
          }

          if (dtArticles.Rows.Count > 2) // top 3 - 8
          {
