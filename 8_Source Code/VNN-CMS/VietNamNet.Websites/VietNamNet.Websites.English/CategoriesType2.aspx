...
<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Codebehind="CategoriesType2.aspx.cs"
  Inherits="VietNamNet.Websites.English.CategoriesType2" %>
  ...
  <div class="home-body">
    ...
    <div class="body680">
      ...
      <div class="body680-box3">
        ...
        <div class="pdlr5">
          <div class="bg_title3">
            Vietnam Reference</div>
          <img src="/images/mapvn.jpg" width="670" />
        ...
        <div class="pd5 ">
          <div class="home-cate-left">
            <uc:PanelSmallCateBox CategoryAlias="vietnam-reference-provinces-cities" ID="PanelSmallCateBox1" runat="server" />
          </div>
          <div class="home-cate-right">
            <uc:PanelSmallCateBox CategoryAlias="vietnam-reference-general-information" ID="PanelSmallCateBox2" runat="server" />
          </div>
          <br class="clear" />
        </div>
