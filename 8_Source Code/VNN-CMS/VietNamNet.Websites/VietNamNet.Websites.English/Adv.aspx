...
<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Codebehind="Adv.aspx.cs"
  Inherits="VietNamNet.Websites.English.Adv" %>

<%@ Register Src="UserControls/PanelAdv.ascx" TagName="PanelAdv" TagPrefix="uc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="home-body">
    <div class="body680">
      ...
      <uc:PanelAdv ID="PanelAdv1" runat="server" />
