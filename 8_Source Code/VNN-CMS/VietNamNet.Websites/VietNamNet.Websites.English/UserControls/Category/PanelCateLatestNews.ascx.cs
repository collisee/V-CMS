...
{
    public partial class PanelCateLatestNews : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                helperArticlesTop.ValueObject.LastIndexRecord = 10;
                DataTable dtArticlesTop = helperArticlesTop.GetCategoryArticles();
                rptLatestNews.DataSource = dtArticlesTop;
