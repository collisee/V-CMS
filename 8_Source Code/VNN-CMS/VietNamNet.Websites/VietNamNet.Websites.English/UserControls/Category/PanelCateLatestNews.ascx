<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelCateLatestNews.ascx.cs" Inherits="VietNamNet.Websites.English.UserControls.Category.PanelCateLatestNews" %>
