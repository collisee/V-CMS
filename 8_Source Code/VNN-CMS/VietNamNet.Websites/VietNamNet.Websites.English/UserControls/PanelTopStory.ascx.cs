...
{
    public partial class PanelTopStory : System.Web.UI.UserControl
    {
        ...
        public string CategoryAlias
        {
            get
            {
                return Nulls.IsNullOrEmpty(ViewState[WebsitesConstants.ViewState.CategoryAlias])
                    ? string.Empty
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                rptTopStories.DataSource = dtArticlesTop;
                rptTopStories.DataBind();
