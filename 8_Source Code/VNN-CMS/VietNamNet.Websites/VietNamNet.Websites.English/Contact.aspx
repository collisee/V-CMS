...
<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Codebehind="Contact.aspx.cs"
  Inherits="VietNamNet.Websites.English.Contact" %>

<%@ Register Src="UserControls/PanelContact.ascx" TagName="PanelContact" TagPrefix="uc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="home-body">
    <div class="body680">
      ...
      <uc:PanelContact ID="PanelContact1" runat="server" />
