...
<%@ Register Src="UserControls/Homepage/PanelSmallBar.ascx" TagName="PanelSmallBar" TagPrefix="uc" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            ...
            <uc:PanelSmallBar FirstIndexRecord="1" LastIndexRecord="6" CategoryAlias="ho-chi-minh" id="PanelSmallBar1" runat="server" />
