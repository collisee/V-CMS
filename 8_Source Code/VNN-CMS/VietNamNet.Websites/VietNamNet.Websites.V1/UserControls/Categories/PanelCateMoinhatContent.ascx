...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelCateMoinhatContent.ascx.cs" Inherits="VietNamNet.Websites.V1.UserControls.Categories.PanelCateMoinhatContent" %>
