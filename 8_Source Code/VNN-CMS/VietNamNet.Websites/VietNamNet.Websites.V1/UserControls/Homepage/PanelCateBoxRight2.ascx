<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelCateBoxRight2.ascx.cs" Inherits="VietNamNet.Websites.V1.UserControls.Homepage.PanelCateBoxRight2" %>
<%@ Import Namespace="VietNamNet.Framework.Common" %>
<%@ Import Namespace="VietNamNet.Websites.Core.Common" %>
<div class="box-ttola">
        <div class="sao-title">
            <a href="http://2sao.vietnamnet.vn" target="_blank">
                <img height="25" width="135" src="http://res.vietnamnet.vn/images/blank.gif" alt="#"></a></div>
        <div class="ttol-text">
