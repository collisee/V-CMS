...
<div class="first_new_home">
  <div class="boder1">
    <img src="http://res.vietnamnet.vn/images/new_boder1.gif" width="280px" height="3" /></div>
  <%--<ul class="u1_tooltip">--%>
  <div id="firstNew">
  ...
  <div class="boder2">
    <img src="http://res.vietnamnet.vn/images/new_boder2.gif" width="280px" height="3" /></div>
</div>

<script type="text/javascript">
    function initFirstNew(){
        var hp = $('#firstNew').height();
        var tp = $('#firstNew').offset().top;
