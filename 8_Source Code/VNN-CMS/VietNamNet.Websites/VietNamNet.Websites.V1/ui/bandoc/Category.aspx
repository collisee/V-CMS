...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  ...
  <div id="home4">
    <div id="home4_1">
      ...
      <uc:PanelCateCenterPoint ID="PanelCateCenterPoint1" FirstIndexRecord="2" LastIndexRecord="4"
        runat="server" />
      <div class="clear">
        ,</div>
  ...
  <div id="home5">
    ...
    <div class="home5right">
      <div class="home5_right">
        <uc:PanelCateBox CategoryAlias="ban-doc-phap-luat-chia-se" FirstIndexRecord="1" LastIndexRecord="4"
