    ...
    <div id="home5">
        ...
        <div class="home5right">
            <div class="home5_right">
                <uc:PanelCateBox CategoryAlias="giao-duc-du-hoc" FirstIndexRecord="1" LastIndexRecord="4"
                    ID="PanelCateBox1" runat="server" />
                <uc:PanelCateBox CategoryAlias="giao-duc-nep-nha" FirstIndexRecord="1" LastIndexRecord="4"
                    ID="PanelCateBox2" runat="server" />
                <uc:PanelCateBox CategoryAlias="giao-duc-chuyen-giang-duong" FirstIndexRecord="1" LastIndexRecord="4"
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">                            
                            ...
                            <vnn:PaneSurvey ID="PaneSurvey1" runat="server" CategoryAlias="giao-duc" />              
