...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="VietNamNet.Websites.V1.ui.giaoduc.Detail" %>
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">                            
                            ...
                            <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" CategoryAlias="giao-duc-dong-su-kien" ID="PanelCateBox1_2" runat="server" />
