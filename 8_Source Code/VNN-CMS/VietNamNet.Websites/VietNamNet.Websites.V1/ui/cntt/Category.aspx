...
<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" Codebehind="Category.aspx.cs"
  Inherits="VietNamNet.Websites.V1.ui.cntt.Category" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  <uc:PanelCateTicker CategoryAlias="cong-nghe-thong-tin-vien-thong" ID="PanelCateTicker1"
    runat="server" />
  <div id="home4">
    <div id="home4_1">
      <uc:PanelCateHotNews ID="PanelCateHotNews1"
        runat="server" />
      <uc:PanelCateCenterPoint ID="PanelCateCenterPoint1" FirstIndexRecord="2" LastIndexRecord="4"
        runat="server" />
      <div class="clear">
        ,</div>
      <uc:PanelCateHotSlide CategoryAlias="cong-nghe-thong-tin-vien-thong-tam-diem" FirstIndexRecord="1"
  ...
  <div id="home5">
    <div class="home5left">
      ...
      <uc:PanelCateContent CategoryAlias="cong-nghe-thong-tin-vien-thong" ID="PanelCateContent1"
        runat="server" />
      <uc:PanelOtherNews CategoryAlias="cong-nghe-thong-tin-vien-thong" ID="PanelOtherNews1"
        runat="server" />
    </div>
    <div class="home5right">
      <div class="home5_right">
        <uc:PanelBoxViettel id="PanelBoxViettel1" CategoryAlias="hop-tac-viettel" FirstIndexRecord="1"
  ...
  <uc:PanelAdvertisement CategoryAlias="cong-nghe-thong-tin-vien-thong" ID="PanelAdvertisement1"  runat="server" />
</asp:Content>
