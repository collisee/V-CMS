...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  ...
  <div id="home4">
    <div id="home4_1">
      ...
      <uc:PanelCateCenterPoint ID="PanelCateCenterPoint1" FirstIndexRecord="2" LastIndexRecord="4" runat="server" />
      <div class="clear">
        ,</div>
  ...
  <div id="home5">
    ...
    <div class="home5right">
      <div class="home5_right">
        <uc:PanelCateBox CategoryAlias="quoc-te-ho-so" FirstIndexRecord="1" LastIndexRecord="4"
          ID="PanelCateBox2" runat="server" />
        <uc:PanelCateBox CategoryAlias="quoc-te-the-gioi-do-day" FirstIndexRecord="1" LastIndexRecord="4"
        ...
        <div class="row">
          <div>
            <div class="tt_ck">
              <uc:PanelCateImageNews CategoryAlias="quoc-te-tin-anh" FirstIndexRecord="1" LastIndexRecord="3"
