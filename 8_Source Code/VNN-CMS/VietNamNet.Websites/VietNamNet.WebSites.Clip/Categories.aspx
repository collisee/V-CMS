<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" Codebehind="Categories.aspx.cs" Inherits="VietNamNet.Websites.Clip.Categories" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="home4">
        <div id="home4_1">
            <uc:PanelCateHotNews FirstIndexRecord="2" LastIndexRecord="4" ID="PanelCateHotNews1" runat="server" />
            <uc:PanelCateCenterPoint FirstIndexRecord="1" LastIndexRecord="3" ID="PanelCateCenterPoint1" runat="server" />
            <div class="clear">,</div>
            <uc:PanelCateHotSlide FirstIndexRecord="5" LastIndexRecord="9" ID="PanelCateHotSlide1" runat="server" />
        </div>
        <div id="home4_2">
    ...
    <div id="home5">
        ...
        <div class="home5right">
            <div class="home5_right">
                <uc:PanelCateBox FirstIndexRecord="1" LastIndexRecord="3" ID="PanelCateBox1" runat="server" />
                <uc:PanelCateBox FirstIndexRecord="1" LastIndexRecord="3" ID="PanelCateBox2" runat="server" />
                <div class="row">
                ...
                <div class="row">
                    <div>
                        <div class="tt_ck">
                            <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" ID="PanelCateBox1_1" runat="server" />
                            <uc:PanelCateBox1 FirstIndexRecord="1" LastIndexRecord="3" ID="PanelCateBox1_2" runat="server" />
