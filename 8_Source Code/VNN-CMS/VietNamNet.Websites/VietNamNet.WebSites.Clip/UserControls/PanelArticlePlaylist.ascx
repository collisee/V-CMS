<%@ Control Language="C#" AutoEventWireup="true" Codebehind="PanelArticlePlaylist.ascx.cs"
  Inherits="VietNamNet.Websites.Clip.ui._3g.PanelArticlePlaylist" %>
<div class="clip_hot">
...
<div class="clip_static ">
  <div class="clip_linkurl">
    ...
    <input id="embed-code" type="text" class="box_linkurl" value="http://www.vietnamnet.vn" />
    <div class="clear">
      &nbsp;</div>
  </div>
          ...
          <asp:Repeater ID="rptNewsDetail" runat="server">
            <ItemTemplate>
              ...
              <input id="hidMessageSubject" name="hidMessageSubject" value="<%#DataBinder.Eval(Container.DataItem, "Name") %>"
                type="hidden">
              <a href="javascript:sendEmail()">Gửi</a></ItemTemplate>
          </asp:Repeater>
        </td>
      </tr>
    </table>
