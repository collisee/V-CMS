...
namespace VietNamNet.Layout.Mobile.UserControls
{
    public partial class PanelSendFeedBack : UserControl
    {
        ...
        public string ArticleName
        {
            get
            {
                return Nulls.IsNullOrEmpty(ViewState[VNN4MobileConstants.ViewState.ArticleName])
                           ? string.Empty
                           : ViewState[VNN4MobileConstants.ViewState.ArticleName].ToString();
            }
            set { ViewState[VNN4MobileConstants.ViewState.ArticleName] = value; }
        }
        ...
        {
            int width = Utilities.ParseInt(Utilities.GetConfigKey(VNN4MobileConstants.ConfigKey.ValidImageWidth));
            int height = Utilities.ParseInt(Utilities.GetConfigKey(VNN4MobileConstants.ConfigKey.ValidImageheight));
