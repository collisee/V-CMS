...
using VietNamNet.CMS.Articles.UserControls;
...
{
    public partial class ArticleEdit : ArticleBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ((RadToolBarDropDown)radToolBarDefault.Items[8]).Buttons[1].Visible =
                    ((RadToolBarDropDown)radToolBarDefault.Items[8]).Buttons[1].Enabled = CMSUtils.GetRoyaltyPolicy(UserId);
            }
        }
        ...
        private void BindData()
        {
            ...
            pnlArticleCategory.Visible = false;
            pnlArticleCategory2.BindDataToCategories();
            pnlArticleEventItem.BindDataToItems();

            //logging
            SystemLogging.Info("Create Article");
        }
        ...
        private void BindData(Article o)
        {
            ...
            BindDataToUser(0, UserId);
            BindDataToCollaborator(0);
            cmbShowComment.SelectedValue = o.ShowComment.ToString();
            ...
            {
                plhNotMember.Visible = false;
                cmbUser.SelectedValue = o.AuthorId.ToString();
            ...
            else //Coongj tacs vieen
            {
                ...
                cmbCollaborator.SelectedValue = o.AuthorId.ToString();
            ...
            pnlArticleCategory2.Visible = false;
            ...
            //logging
            SystemLogging.Info("Open Article", string.Format("{0} - {1}", o.Id, o.Name));
        }

        private int AddNewCollaborator(string name, string detail)
        {
            CollaboratorHelper helper = new CollaboratorHelper(new Collaborator());
            ...
            return (helper.ValueObject != null) ? helper.ValueObject.Id : 0;
        }
        ...
        private bool GetData(Article o)
        {
            ...
            //Categories
            //Control pnlCategories = rpvPublish.FindControl("pnlArticleCategory");
            //if (pnlCategories != null && pnlCategories.GetType().BaseType.Equals(typeof(PanelArticleCategory1)))
            //{
            //    ((PanelArticleCategory1)pnlCategories).GetDataCategories();
            //}
            //if (pnlCategories != null && pnlCategories.GetType().BaseType.Equals(typeof(PanelArticleCategory2)))
            //{
            //    ((PanelArticleCategory2)pnlCategories).GetDataCategories();
            //}
            if (pnlArticleCategory2.Visible)
            {
                pnlArticleCategory2.GetDataCategories();
            }
            ...
            o.ShowComment = Utilities.ParseInt(cmbShowComment.SelectedValue);
            o.IsMember = Utilities.ParseInt(cmbIsMember.SelectedValue);
            if (o.IsMember == 1) //Phongs vieen
            {
                o.AuthorId = Utilities.ParseInt(cmbUser.SelectedValue);
            ...
            else //Coongj tacs vieen
            {
                ...
                if (collaboratorId == 0)
                {
                    o.AuthorId = AddNewCollaborator(cmbCollaborator.Text, txtAuthorInfo.Text.Trim());
                }
            ...
            {
                if (Utilities.ParseInt(row[CMSConstants.Entities.ArticleCategory.FieldName.PrimaryCategory]) == 1
                    && !Utilities.StringCompare(row[CMSConstants.Entities.ArticleCategory.FieldName.SaveStatus], Constants.CommonStatus.DELETE))
                {
        ...
        private void DoSave(string status, bool royalty)
        {
            ...
            if (GetData(helper.ValueObject))
            {
                ...
                switch (status)
                {
                    case CMSConstants.ArticleStatus.Draft:
                        //logging
                        SystemLogging.Info("Save Article", txtName.Text);
                    ...
                    case CMSConstants.ArticleStatus.Submited:
                        //logging
                        SystemLogging.Info("Submit Article", txtName.Text);
                    ...
                    case CMSConstants.ArticleStatus.Editted:
                        //logging
                        SystemLogging.Info("Edit Article", txtName.Text);
                    ...
                    case CMSConstants.ArticleStatus.Corrected:
                        //logging
                        SystemLogging.Info("Correct Article", txtName.Text);
                    ...
                    case CMSConstants.ArticleStatus.Published:
                        //logging
                        SystemLogging.Info("Publish Article", txtName.Text);
                    ...
                    case CMSConstants.ArticleStatus.Rejected:
                        //logging
                        SystemLogging.Info("Reject Article", txtName.Text);
                    ...
                    case CMSConstants.ArticleStatus.Stopped:
                        //logging
                        SystemLogging.Info("Stop Article", txtName.Text);
