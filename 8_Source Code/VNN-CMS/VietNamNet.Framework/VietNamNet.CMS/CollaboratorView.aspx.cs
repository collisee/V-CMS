...
{
    public partial class CollaboratorView : BasePageView
    {
        ...
        private void Initialize()
        {
            ...
            ServiceName = CMSConstants.Services.CollaboratorManager.Name;
            ActionName = CMSConstants.Services.CollaboratorManager.Actions.ViewGetAllCollaborator;
        }
        ...
        protected void radToolBarDefault_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            ...
            switch (((RadToolBarButton)e.Item).CommandName)
            {
                case Constants.CommandNames.AddNew:
                    Utilities.Redirect(CMSConstants.FormNames.CMS.CollaboratorEdit);
                    break;
        ...
        protected override void radGridDefault_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            {
                Utilities.Redirect(CMSConstants.FormNames.CMS.CollaboratorDisplay,
