...
{
    public partial class ArticleCommentViewByStatus : BasePageView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //logging
                SystemLogging.Info("View Comments", Request.Url.ToString());
        ...
        private void Initialize()
        {
            ...
            ActionName = CMSConstants.Services.ArticleCommentManager.Actions.ViewGetAllArticleCommentByStatus;
        }
