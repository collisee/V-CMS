<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PanelArticleSelection.ascx.cs" Inherits="VietNamNet.CMS.UserControls.Commons.PanelArticleSelection" %>
...
<asp:Panel ID="pnlSearch" runat="server" CssClass="pd05 pb00">
    ...
    <telerik:RadComboBox ID="cmbCategory" runat="server" DataValueField="Id" DataTextField="Name" 
        EmptyMessage="Chọn danh mục..." Width="250px">
    </telerik:RadComboBox>
