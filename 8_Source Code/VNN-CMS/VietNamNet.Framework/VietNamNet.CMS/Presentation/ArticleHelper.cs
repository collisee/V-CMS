...
namespace VietNamNet.CMS.Presentation
{
    ...
    public class ArticleHelper
    {
        ...
        private Packet GetPacket()
        {
            ...
            if (ValueObject.EventItems != null)
            {
                ValueObject.EventItems.TableName = CMSConstants.Entities.Article.EventItems;
                p.RawData.Tables.Add(ValueObject.EventItems.Copy());
            }
            return p;
        }
        ...
        public void Load()
        {
            ...
            if (ValueObject != null)
            {
                ...
                ValueObject.EventItems = p.RawData.Tables[CMSConstants.Entities.Article.EventItems];
            }
        }
