<%@ Page MasterPageFile="~/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="AdvertisementItemEdit.aspx.cs" Inherits="VietNamNet.AddOn.Advertisement.AdvertisementItemEdit" 
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cplhContainer">
    ...
    <div class="pd05">
        ...
        <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
            ...
            <asp:PlaceHolder ID="plhIFrame" runat="server">
                <p>
                    <asp:Label ID="lblFileJS1Label" runat="server" CssClass="label w150" Text="File link:"></asp:Label>
                    <telerik:RadTextBox ID="txtFileJS1" runat="server" Width="450px" MaxLength="255"></telerik:RadTextBox>
                    <br class="clear" />
                </p>
            </asp:PlaceHolder>
            <p>
