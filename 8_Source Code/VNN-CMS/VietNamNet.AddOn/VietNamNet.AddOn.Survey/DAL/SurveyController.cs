...
namespace VietNamNet.AddOn.SurveyModule.DAL
{
    ...
    public partial class SurveyController
    {
	    ...
	    public void Insert(string Question,string Tags,string OptionType,string Notes,string CreatedBy,DateTime CreatedOn,string ModifiedBy,DateTime ModifiOn,bool IsDeleted,bool IsActive,byte? Status)
	    {
