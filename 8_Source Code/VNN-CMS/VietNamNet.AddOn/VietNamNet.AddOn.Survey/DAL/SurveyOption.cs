...
namespace VietNamNet.AddOn.SurveyModule.DAL
{
	...
	public partial class SurveyOption : ActiveRecord<SurveyOption>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SurveyOptions", TableType.Table, DataService.GetInstance("VietNamNet_Surveys"));
				...
				colvarSurveyOptionId.AutoIncrement = true;
				...
				colvarSurveyId.DefaultSetting = @"";
					...
					colvarSurveyId.ForeignKeyTableName = "Surveys";
				...
				colvarIsOther.IsReadOnly = false;
						...
						colvarIsOther.DefaultSetting = @"((0))";
				...
				colvarIsCorrect.IsReadOnly = false;
						...
						colvarIsCorrect.DefaultSetting = @"((0))";
				...
				DataService.Providers["VietNamNet_Surveys"].AddSchema("SurveyOptions",schema);
			}
		}
		#endregion
		...
		public VietNamNet.AddOn.SurveyModule.DAL.SurveyResultCollection SurveyResults()
		{
			return new VietNamNet.AddOn.SurveyModule.DAL.SurveyResultCollection().Where(SurveyResult.Columns.SurveyOptionId, SurveyOptionId).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a Survey ActiveRecord object related to this SurveyOption
		/// 
		/// </summary>
		public VietNamNet.AddOn.SurveyModule.DAL.Survey Survey
		{
			get { return VietNamNet.AddOn.SurveyModule.DAL.Survey.FetchByID(this.SurveyId); }
			set { SetColumnValue("SurveyId", value.SurveyId); }
		}
		...
		/// </summary>
		public static void Insert(int varSurveyId,string varOptionName,int varViewOrder,string varNotes,bool? varIsOther,bool? varIsCorrect,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiOn,bool varIsDeleted,bool varIsActive)
		{
