<%@ Page MasterPageFile="~/Popup.Master" Language="C#" AutoEventWireup="true" CodeBehind="PopupListArticleBySurvey.aspx.cs" Inherits="VietNamNet.AddOn.Survey.PopupListArticleBySurvey" Title="Danh sách Tin của Bình chọn" ValidateRequest="false"  %>

<%@ Register Src="UserControls/ArticlesSearch.ascx" TagName="ArticlesSearch" TagPrefix="vnnSurvey" %>

<%@ Register Src="UserControls/SurveyPublishEdit.ascx" TagName="SurveyPublishEdit"    TagPrefix="vnnSurvey" %>
<%@ Register Src="UserControls/SurveyPublishArticleList.ascx" TagName="SurveyPublishArticleList"    TagPrefix="vnnSurvey" %>
          ...
          <p class="rpCheckBoxPanel">  
            ...
            <telerik:RadMultiPage  ID="RadMultiPage1" runat="server"  SelectedIndex="1" CssClass="multiPage">
                ...
                <telerik:RadPageView ID="pwSearchInfo" runat="server" CssClass="pageViewEducation"> 
                    ...
                    <vnnSurvey:SurveyPublishArticleList ID="SurveyPublishArticleList1" runat="server" />
                ...
                <telerik:RadPageView ID="pwConfig" runat="server" CssClass="pageViewEducation" >
                   ...
                   <telerik:RadTextBox ID="txtSurveyPublishId" runat="server"  style="display:none;"     ></telerik:RadTextBox>
          </p> 
          </asp:Panel> 
     </div> 
