<%@ Page MasterPageFile="~/Popup.Master" Language="C#" AutoEventWireup="true" CodeBehind="PopupSurveyResult.aspx.cs" Inherits="VietNamNet.AddOn.Survey.PopupSurveyResult" Title="Kết quả Bình chọn" %>
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="txtSurveyId">
             ...
             <telerik:AjaxSetting AjaxControlID="radToolBarDefault">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="lblMessage" /> 
                    <telerik:AjaxUpdatedControl ControlID="txtSurveyId" />
                </UpdatedControls>
            </telerik:AjaxSetting> 
        </AjaxSettings>
            ...
            <telerik:RadToolBar ID="radToolBarDefault" runat="server" 
                ...
                <Items> 
                     <telerik:RadToolBarButton runat="server"
                                    ...
                                    Text="Xu?t Survey (E)" AccessKey="E">
                    </telerik:RadToolBarButton>
                    <telerik:RadToolBarButton runat="server"
                                    CommandName="Update" Value="Update"
                                    Text="C?p nh?t (U)" AccessKey="U">
                    </telerik:RadToolBarButton>
                    <telerik:RadToolBarButton runat="server" 
          ...
          <p class="rpCheckBoxPanel">  
            ...
            <telerik:RadMultiPage  ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="multiPage">
                <telerik:RadPageView ID="RadPageView1" runat="server">
                   ...
                   <table>
                        <tr> 
                            <td  width="100"><label>H? tên</label></td>
                   ...
                   <table>
                     <tr>
                        <td colspan="2"><label>Mô t?</label> </td>
                     </tr>
                     <tr>
                        <td colspan="2">
                ...
                <telerik:RadPageView ID="RadPageView2" runat="server" CssClass="pageViewEducation">
                    <table cellspacing="2" cellpadding="2">
                        <tr>
                            ...
                            <td  width="100"><label>S?T C? ??nh</label></td>
                        ...
                        <tr>
                            <td valign="top"><label>??a ch? </label></td>
                            <td colspan="3">
                ...
                <telerik:RadPageView ID="RadPageView3" runat="server">
                    <table cellspacing="2" cellpadding="2">
                        ...
                        <tr>
                            <td valign="top"><label>??a ch? nhà&nbsp;</label></td>
                            <td colspan="3">
                   ...
                   <telerik:RadTextBox ID="txtSurveyId" runat="server" Visible="false" OnTextChanged="txtSurveyIdTextChanged"   ></telerik:RadTextBox>
          </p>
          <asp:Panel  class="rpCheckBoxPanel" runat="server" ID="pnUpload">
            <label>??c thông tin t? file Survey:</label>
            <asp:FileUpload ID="FileUpload1" runat="server" />
            <asp:Button ID="cmdRead" runat="server" Text="??c" OnClick="CmdReadClick" />          
