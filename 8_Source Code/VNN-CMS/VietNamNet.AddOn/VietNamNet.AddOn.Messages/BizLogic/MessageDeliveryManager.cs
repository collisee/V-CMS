...
{
    /// <summary>
    /// Summary description for MessageDeliveryManager.
    /// </summary>
    public class MessageDeliveryManager : Facade
    {
        ...
        {
            if (Utilities.ParseInt(param.RawData.Tables[0].Rows[0][MessagesConstants.Entities.MessageDelivery.FieldName.Id]) == 0)
            {
                MessageDeliveryDAO.Insert(param.RawData.Tables[0].Rows[0]);
            }
            else
            {
                MessageDeliveryDAO.Update(param.RawData.Tables[0].Rows[0]);
            }
        }
        ...
        {
            MessageDeliveryDAO.Delete(param.RawData.Tables[0].Rows[0]);
        }
        ...
        {
            DataTable dt = MessageDeliveryDAO.SelectOne(param.RawData.Tables[0].Rows[0]);
        ...
        {
            DataTable dt = MessageDeliveryDAO.SelectAll();
            param.RawData.Tables.Clear();
            param.RawData.Tables.Add(dt.Copy());
        }
