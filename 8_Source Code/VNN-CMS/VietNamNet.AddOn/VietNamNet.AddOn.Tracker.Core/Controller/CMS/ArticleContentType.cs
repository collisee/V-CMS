...
{
	/// <summary>
	/// Strongly-typed collection for the ArticleContentType class.
	/// </summary>
    [Serializable]
	public partial class ArticleContentTypeCollection : ActiveList<ArticleContentType, ArticleContentTypeCollection>
	{	   
		public ArticleContentTypeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ArticleContentTypeCollection</returns>
		public ArticleContentTypeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ArticleContentType o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ArticleContentType table.
	/// </summary>
	[Serializable]
	public partial class ArticleContentType : ActiveRecord<ArticleContentType>, IActiveRecord
	{
		...
		public ArticleContentType(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ArticleContentType(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ArticleContentType(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleContentType", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("ArticleContentType",schema);
			}
		}
		#endregion
		...
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleVersionCollection().Where(ArticleVersion.Columns.ArticleContentTypeId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.ArticleCollection ArticleRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleCollection().Where(Article.Columns.ArticleContentTypeId, Id).Load();
		}
		#endregion
