...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class AdvertisementItem : ActiveRecord<AdvertisementItem>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementItem", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AdvertisementItem",schema);
			}
		}
		#endregion
		...
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementBlockItemCollection().Where(AdvertisementBlockItem.Columns.ItemId, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementType AdvertisementType
		{
			get { return VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementType.FetchByID(this.TypeId); }
