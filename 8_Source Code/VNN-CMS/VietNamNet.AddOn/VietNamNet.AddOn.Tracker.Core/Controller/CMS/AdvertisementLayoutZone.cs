...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class AdvertisementLayoutZone : ActiveRecord<AdvertisementLayoutZone>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementLayoutZone", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AdvertisementLayoutZone",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementLayout AdvertisementLayout
		{
			get { return VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementLayout.FetchByID(this.LayoutId); }
