...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class AdvertisementBlock : ActiveRecord<AdvertisementBlock>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementBlock", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AdvertisementBlock",schema);
			}
		}
		#endregion
		...
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementBlockItemCollection AdvertisementBlockItemRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementBlockItemCollection().Where(AdvertisementBlockItem.Columns.BlockId, Id).Load();
		}
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementZoneBlockCollection AdvertisementZoneBlockRecords()
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementZoneBlockCollection().Where(AdvertisementZoneBlock.Columns.BlockId, Id).Load();
		}
		#endregion
