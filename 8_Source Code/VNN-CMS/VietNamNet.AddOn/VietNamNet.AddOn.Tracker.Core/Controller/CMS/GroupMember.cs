...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class GroupMember : ActiveRecord<GroupMember>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("GroupMember", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("GroupMember",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public VietNamNet.AddOn.Tracker.Core.CMS.User User
		{
			get { return VietNamNet.AddOn.Tracker.Core.CMS.User.FetchByID(this.UserId); }
