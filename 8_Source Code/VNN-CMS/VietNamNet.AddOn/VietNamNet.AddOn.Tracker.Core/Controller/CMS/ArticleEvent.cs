...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class ArticleEvent : ActiveRecord<ArticleEvent>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleEvent", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("ArticleEvent",schema);
			}
		}
		#endregion
		...
		{
			return new VietNamNet.AddOn.Tracker.Core.CMS.ArticleEventCategoryCollection().Where(ArticleEventCategory.Columns.ArticleEventId, Id).Load();
		}
		#endregion
