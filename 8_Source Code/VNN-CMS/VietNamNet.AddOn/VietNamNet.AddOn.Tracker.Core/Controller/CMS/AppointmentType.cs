...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class AppointmentType : ActiveRecord<AppointmentType>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AppointmentType", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AppointmentType",schema);
			}
		}
		#endregion
