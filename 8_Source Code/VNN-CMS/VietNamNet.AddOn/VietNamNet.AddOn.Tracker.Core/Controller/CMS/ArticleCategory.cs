...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class ArticleCategory : ActiveRecord<ArticleCategory>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleCategory", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("ArticleCategory",schema);
			}
		}
		#endregion
