...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class AdvertisementBlockItem : ActiveRecord<AdvertisementBlockItem>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementBlockItem", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("AdvertisementBlockItem",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementItem AdvertisementItem
		{
			get { return VietNamNet.AddOn.Tracker.Core.CMS.AdvertisementItem.FetchByID(this.ItemId); }
