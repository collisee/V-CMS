...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class RoomBooking : ActiveRecord<RoomBooking>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RoomBooking", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("RoomBooking",schema);
			}
		}
		#endregion
