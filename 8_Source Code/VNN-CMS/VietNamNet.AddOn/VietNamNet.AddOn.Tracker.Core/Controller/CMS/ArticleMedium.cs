...
namespace VietNamNet.AddOn.Tracker.Core.CMS
{
	...
	public partial class ArticleMedium : ActiveRecord<ArticleMedium>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleMedia", TableType.Table, DataService.GetInstance("VNN"));
				...
				DataService.Providers["VNN"].AddSchema("ArticleMedia",schema);
			}
		}
		#endregion
