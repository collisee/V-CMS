...
namespace DAL
{
	...
	public partial class AdvertisementItem : ActiveRecord<AdvertisementItem>, IActiveRecord
	{
		...
		{
			return new DAL.AdvertisementBlockItemCollection().Where(AdvertisementBlockItem.Columns.ItemId, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public DAL.AdvertisementType AdvertisementType
		{
			get { return DAL.AdvertisementType.FetchByID(this.TypeId); }
