...
namespace DAL
{
	...
	public partial class AdvertisementType : ActiveRecord<AdvertisementType>, IActiveRecord
	{
		...
		public DAL.AdvertisementItemCollection AdvertisementItemRecords()
		{
			return new DAL.AdvertisementItemCollection().Where(AdvertisementItem.Columns.TypeId, Id).Load();
		}
		#endregion
