...
{
	/// <summary>
	/// Strongly-typed collection for the Configuration class.
	/// </summary>
    [Serializable]
	public partial class ConfigurationCollection : ActiveList<Configuration, ConfigurationCollection>
	{	   
		...
		public ConfigurationCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                Configuration o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Configuration table.
	/// </summary>
	[Serializable]
	public partial class Configuration : ActiveRecord<Configuration>, IActiveRecord
	{
		...
		public Configuration(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Configuration(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Configuration(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Configuration", TableType.Table, DataService.GetInstance("VCMS"));
				...
				colvarVal.DataType = DbType.String;
				colvarVal.MaxLength = 255;
				...
				DataService.Providers["VCMS"].AddSchema("Configuration",schema);
			}
		}
		#endregion
		...
		public string Val 
		{
			get { return GetColumnValue<string>(Columns.Val); }
		...
		/// </summary>
		public static void Insert(string varName,string varVal,string varDetail,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
		...
		/// </summary>
		public static void Update(int varId,string varName,string varVal,string varDetail,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
			Configuration item = new Configuration();
