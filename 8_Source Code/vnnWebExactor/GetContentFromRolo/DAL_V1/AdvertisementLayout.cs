...
namespace DAL
{
	...
	public partial class AdvertisementLayout : ActiveRecord<AdvertisementLayout>, IActiveRecord
	{
		...
		public DAL.AdvertisementLayoutCategoryCollection AdvertisementLayoutCategoryRecords()
		{
			return new DAL.AdvertisementLayoutCategoryCollection().Where(AdvertisementLayoutCategory.Columns.LayoutId, Id).Load();
		}
		public DAL.AdvertisementLayoutZoneCollection AdvertisementLayoutZoneRecords()
		{
			return new DAL.AdvertisementLayoutZoneCollection().Where(AdvertisementLayoutZone.Columns.LayoutId, Id).Load();
		}
		#endregion
