...
namespace DAL
{
	...
	public partial class ArticleContentType : ActiveRecord<ArticleContentType>, IActiveRecord
	{
		...
		public DAL.ArticleCollection ArticleRecords()
		{
			return new DAL.ArticleCollection().Where(Article.Columns.ArticleContentTypeId, Id).Load();
		}
		public DAL.ArticleVersionCollection ArticleVersionRecords()
		{
			return new DAL.ArticleVersionCollection().Where(ArticleVersion.Columns.ArticleContentTypeId, Id).Load();
		}
		#endregion
