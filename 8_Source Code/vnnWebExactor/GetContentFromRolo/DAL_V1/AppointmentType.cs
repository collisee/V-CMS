...
{
	/// <summary>
	/// Strongly-typed collection for the AppointmentType class.
	/// </summary>
    [Serializable]
	public partial class AppointmentTypeCollection : ActiveList<AppointmentType, AppointmentTypeCollection>
	{	   
		public AppointmentTypeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AppointmentTypeCollection</returns>
		public AppointmentTypeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AppointmentType o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AppointmentType table.
	/// </summary>
	[Serializable]
	public partial class AppointmentType : ActiveRecord<AppointmentType>, IActiveRecord
	{
		...
		public AppointmentType(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AppointmentType(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AppointmentType(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AppointmentType", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("AppointmentType",schema);
			}
		}
		#endregion
