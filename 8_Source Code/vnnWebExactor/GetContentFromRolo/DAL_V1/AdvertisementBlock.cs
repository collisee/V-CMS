...
namespace DAL
{
	...
	public partial class AdvertisementBlock : ActiveRecord<AdvertisementBlock>, IActiveRecord
	{
		...
		public DAL.AdvertisementBlockItemCollection AdvertisementBlockItemRecords()
		{
			return new DAL.AdvertisementBlockItemCollection().Where(AdvertisementBlockItem.Columns.BlockId, Id).Load();
		}
		public DAL.AdvertisementZoneBlockCollection AdvertisementZoneBlockRecords()
		{
			return new DAL.AdvertisementZoneBlockCollection().Where(AdvertisementZoneBlock.Columns.BlockId, Id).Load();
		}
		#endregion
