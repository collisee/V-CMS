...
{
	/// <summary>
	/// Strongly-typed collection for the AdvertisementLayoutZone class.
	/// </summary>
    [Serializable]
	public partial class AdvertisementLayoutZoneCollection : ActiveList<AdvertisementLayoutZone, AdvertisementLayoutZoneCollection>
	{	   
		public AdvertisementLayoutZoneCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AdvertisementLayoutZoneCollection</returns>
		public AdvertisementLayoutZoneCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AdvertisementLayoutZone o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AdvertisementLayoutZone table.
	/// </summary>
	[Serializable]
	public partial class AdvertisementLayoutZone : ActiveRecord<AdvertisementLayoutZone>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AdvertisementLayoutZone()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AdvertisementLayoutZone(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AdvertisementLayoutZone(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AdvertisementLayoutZone(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AdvertisementLayoutZone", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("AdvertisementLayoutZone",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a AdvertisementLayout ActiveRecord object related to this AdvertisementLayoutZone
		/// 
		/// </summary>
		public DAL.AdvertisementLayout AdvertisementLayout
		{
			get { return DAL.AdvertisementLayout.FetchByID(this.LayoutId); }
			set { SetColumnValue("LayoutId", value.Id); }
		}
		
		
		/// <summary>
		/// Returns a AdvertisementZone ActiveRecord object related to this AdvertisementLayoutZone
		/// 
		/// </summary>
		public DAL.AdvertisementZone AdvertisementZone
		{
			get { return DAL.AdvertisementZone.FetchByID(this.ZoneId); }
		...
		/// </summary>
		public static void Insert(int varLayoutId,int varZoneId,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
		...
		/// </summary>
		public static void Update(int varId,int varLayoutId,int varZoneId,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag)
		{
			AdvertisementLayoutZone item = new AdvertisementLayoutZone();
