...
namespace DAL
{
	...
	/// </summary>
	[Serializable]
	public partial class ModuleX : ActiveRecord<ModuleX>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Module", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("Module",schema);
			}
		...
		public DAL.FunctionCollection FunctionRecords()
		{
			return new DAL.FunctionCollection().Where(Function.Columns.ModuleId, Id).Load();
		}

		public DAL.MenuCollection MenuRecords()
		{
			return new DAL.MenuCollection().Where(Menu.Columns.ModuleId, Id).Load();
		}

		public DAL.PolicyCollection PolicyRecords()
		{
			return new DAL.PolicyCollection().Where(Policy.Columns.ModuleId, Id).Load();
		}
