...
namespace DAL
{
	...
	/// </summary>
	[Serializable]
	public partial class Group : ActiveRecord<Group>
	{
		...
		{
			return new DAL.CategoryPolicyCollection().Where(CategoryPolicy.Columns.GroupId, Id).Load();
		}

		public DAL.GroupMemberCollection GroupMemberRecords()
		{
			return new DAL.GroupMemberCollection().Where(GroupMember.Columns.GroupId, Id).Load();
		}

		public DAL.PolicyCollection PolicyRecords()
		{
			return new DAL.PolicyCollection().Where(Policy.Columns.GroupId, Id).Load();
		}
