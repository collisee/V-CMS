...
namespace DAL
{
	...
	public partial class Article : ActiveRecord<Article>
	{
		...
		/// </summary>
		public static void Insert(int varVersionId,string varStatus,int varArticleTypeId,int varArticleContentTypeId,string varName,string varTitle,string varSubTitle1,string varSubTitle2,string varSubTitle3,string varSubTitle4,string varSubTitle5,string varSubTitle6,string varImageLink,string varImageLink1,string varImageLink2,string varImageLink3,string varImageLink4,string varImageLink5,string varLead,string varDetail,DateTime varPublishDate,string varAuthor,string varAuthorInfo,int varIsMember,int varTotalView,string varHistory,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag,string varHref)
		{
		...
		/// </summary>
		public static void Update(int varId,int varVersionId,string varStatus,int varArticleTypeId,int varArticleContentTypeId,string varName,string varTitle,string varSubTitle1,string varSubTitle2,string varSubTitle3,string varSubTitle4,string varSubTitle5,string varSubTitle6,string varImageLink,string varImageLink1,string varImageLink2,string varImageLink3,string varImageLink4,string varImageLink5,string varLead,string varDetail,DateTime varPublishDate,string varAuthor,string varAuthorInfo,int varIsMember,int varTotalView,string varHistory,DateTime varCreatedAt,int varCreatedBy,DateTime varLastModifiedAt,int varLastModifiedBy,string varFlag,string varHref)
		{
			Article item = new Article();
