...
namespace DAL
{
    ...
    public partial class ArticleCategoryController
    {
	    ...
	    public void Insert(int CategoryId,int PartitionId,int ArticleId,int Ord,int ArticleContentTypeId,int PrimaryCategory,DateTime CreatedAt,int CreatedBy,DateTime LastModifiedAt,int LastModifiedBy,string Flag)
	    {
	    ...
	    public void Update(int Id,int CategoryId,int PartitionId,int ArticleId,int Ord,int ArticleContentTypeId,int PrimaryCategory,DateTime CreatedAt,int CreatedBy,DateTime LastModifiedAt,int LastModifiedBy,string Flag)
	    {
		    ArticleCategory item = new ArticleCategory();
