...
namespace DAL
{
    ...
    public partial class CategoryController
    {
	    ...
	    public void Insert(int PartitionId,int? PId,int Ord,string Name,string AliasX,string DisplayName,string Detail,DateTime CreatedAt,int CreatedBy,DateTime LastModifiedAt,int LastModifiedBy,string Flag)
	    {
	    ...
	    public void Update(int Id,int PartitionId,int? PId,int Ord,string Name,string AliasX,string DisplayName,string Detail,DateTime CreatedAt,int CreatedBy,DateTime LastModifiedAt,int LastModifiedBy,string Flag)
	    {
		    Category item = new Category();
