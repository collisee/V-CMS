...
namespace DAL
{
    ...
    public partial class ArticleController
    {
	    ...
	    public void Insert(int VersionId,string Status,int ArticleTypeId,int ArticleContentTypeId,string Name,string Title,string SubTitle1,string SubTitle2,string SubTitle3,string SubTitle4,string SubTitle5,string SubTitle6,string ImageLink,string ImageLink1,string ImageLink2,string ImageLink3,string ImageLink4,string ImageLink5,string Lead,string Detail,DateTime PublishDate,string Author,string AuthorInfo,int IsMember,int TotalView,string History,DateTime CreatedAt,int CreatedBy,DateTime LastModifiedAt,int LastModifiedBy,string Flag,string Href)
	    {
	    ...
	    public void Update(int Id,int VersionId,string Status,int ArticleTypeId,int ArticleContentTypeId,string Name,string Title,string SubTitle1,string SubTitle2,string SubTitle3,string SubTitle4,string SubTitle5,string SubTitle6,string ImageLink,string ImageLink1,string ImageLink2,string ImageLink3,string ImageLink4,string ImageLink5,string Lead,string Detail,DateTime PublishDate,string Author,string AuthorInfo,int IsMember,int TotalView,string History,DateTime CreatedAt,int CreatedBy,DateTime LastModifiedAt,int LastModifiedBy,string Flag,string Href)
	    {
		    Article item = new Article();
