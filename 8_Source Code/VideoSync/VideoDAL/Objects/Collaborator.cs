...
{
	/// <summary>
	/// Strongly-typed collection for the Collaborator class.
	/// </summary>
    [Serializable]
	public partial class CollaboratorCollection : ActiveList<Collaborator, CollaboratorCollection>
	{	   
        ...
        /// </summary>
        /// <returns>CollaboratorCollection</returns>
		public CollaboratorCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                Collaborator o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Collaborator table.
	/// </summary>
	[Serializable]
	public partial class Collaborator : ActiveRecord<Collaborator>, IActiveRecord
	{
		...
		public Collaborator(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Collaborator(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Collaborator(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Collaborator", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("Collaborator",schema);
			}
		}
		#endregion
