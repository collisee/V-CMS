...
namespace VideoDAL
{
	...
	public partial class RoyaltyType : ActiveRecord<RoyaltyType>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RoyaltyTypes", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("RoyaltyTypes",schema);
			}
		}
		#endregion
