...
namespace VideoDAL
{
	...
	public partial class ArticleEvent : ActiveRecord<ArticleEvent>, IActiveRecord
	{
		...
		{
			return new VideoDAL.ArticleEventCategoryCollection().Where(ArticleEventCategory.Columns.ArticleEventId, Id).Load();
		}
		public VideoDAL.ArticleEventItemCollection ArticleEventItemRecords()
		{
			return new VideoDAL.ArticleEventItemCollection().Where(ArticleEventItem.Columns.ArticleEventId, Id).Load();
		}
		#endregion
