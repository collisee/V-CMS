...
namespace VideoDAL
{
	...
	public partial class Category : ActiveRecord<Category>, IActiveRecord
	{
		...
		{
			return new VideoDAL.AdvertisementLayoutCategoryCollection().Where(AdvertisementLayoutCategory.Columns.CategoryId, Id).Load();
		}
		public VideoDAL.ArticleCategoryCollection ArticleCategoryRecords()
		{
			return new VideoDAL.ArticleCategoryCollection().Where(ArticleCategory.Columns.CategoryId, Id).Load();
		}
		public VideoDAL.ArticleEventCategoryCollection ArticleEventCategoryRecords()
		{
			return new VideoDAL.ArticleEventCategoryCollection().Where(ArticleEventCategory.Columns.CategoryId, Id).Load();
		}
		public VideoDAL.CategoryPolicyCollection CategoryPolicyRecords()
		{
			return new VideoDAL.CategoryPolicyCollection().Where(CategoryPolicy.Columns.CategoryId, Id).Load();
		}
		#endregion
