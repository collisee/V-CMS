...
namespace VideoDAL
{
	...
	public partial class ArticleContentType : ActiveRecord<ArticleContentType>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ArticleContentType", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("ArticleContentType",schema);
			}
		}
		#endregion
		...
		public VideoDAL.ArticleCollection ArticleRecords()
		{
			return new VideoDAL.ArticleCollection().Where(Article.Columns.ArticleContentTypeId, Id).Load();
		}
		public VideoDAL.ArticleVersionCollection ArticleVersionRecords()
		{
			return new VideoDAL.ArticleVersionCollection().Where(ArticleVersion.Columns.ArticleContentTypeId, Id).Load();
		}
		#endregion
