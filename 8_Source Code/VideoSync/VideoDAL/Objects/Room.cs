...
namespace VideoDAL
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Room table.
	/// </summary>
	[Serializable]
	public partial class Room : ActiveRecord<Room>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Room", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("Room",schema);
			}
		}
		#endregion
