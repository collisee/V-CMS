...
namespace VideoDAL
{
	...
	public partial class CategoryPolicy : ActiveRecord<CategoryPolicy>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CategoryPolicy", TableType.Table, DataService.GetInstance("VCMS"));
				...
				DataService.Providers["VCMS"].AddSchema("CategoryPolicy",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public VideoDAL.Group Group
		{
			get { return VideoDAL.Group.FetchByID(this.GroupId); }
